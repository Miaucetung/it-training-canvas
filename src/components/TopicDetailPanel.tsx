  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5 space-y-6">
        ...
        {/* ── Topologie-Explorer CTA ── */}
        {hasTopologyExplorer && (
          <section>
            <button
              type="button"
              onClick={() => setTopologyExplorerOpen(true)}
              className={`w-full flex items-center gap-3 rounded-xl border px-4 py-3 text-left transition-colors ${
                dark
                  ? "bg-indigo-500/10 border-indigo-500/30 hover:bg-indigo-500/20 text-indigo-200"
                  : "bg-indigo-50 border-indigo-200 hover:bg-indigo-100 text-indigo-800"
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="text-sm font-semibold">Topologie-Explorer</div>
                <div className="text-xs opacity-80 mt-0.5">
                  Stern · Bus · Ring · Mesh · Baum · Hybrid — mit Paketfluss & Ausfallsimulation
                </div>
              </div>
              <span
                className={`text-xs ${dark ? "text-indigo-300" : "text-indigo-600"}`}
      ...
      {hasTopologyExplorer && topologyExplorerOpen && (
