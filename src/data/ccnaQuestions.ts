    ...
    exhibit: [
      {
        ...
        links: [
          { from: "atl", to: "ny", subnet: "2012::/126", labelFrom: "Se0/0/0", labelTo: "Se0/0/0" },
          { from: "ny", to: "wsh", subnet: "2023::/126", labelFrom: "Se0/0/1", labelTo: "Se0/0/0" },
          { from: "atl", to: "wsh", subnet: "2013::/126", labelFrom: "Se0/0/1", labelTo: "Se0/0/1" },
        ],
        labels: [
          { text: "Lo1 2000::1/128", attachTo: "atl", position: "below" },
          { text: "Lo2 2000::2/128", attachTo: "ny", position: "below" },
      ...
      },
      {
        ...
        rows: [
          ["Atlanta", "Serial 0/0/0", "2012::1/126"],
          ["Atlanta", "Serial 0/0/1", "2013::1/126"],
          ["Atlanta", "Loopback1", "2000::1/128"],
          ["New York", "Serial 0/0/0", "2012::2/126"],
          ["New York", "Serial 0/0/1", "2023::2/126"],
          ["New York", "Loopback2", "2000::2/128"],
...
0 output buffer failures, 0 output buffers swapped out`,
  ...
  },
  {
    ...
    exhibit: {
      type: "cli",
      content: `R43# show interface fa0/0
FastEthernet0/0 is up, line protocol is up
Hardware is DEC21140, address is ca02.7788.0000 (bia ca02.7788.0000)
...
Switch2(config-if)#switchport trunk allowed vlan 5,10`, highlight: ["Switch2(config-if)#switchport mode dynamic auto"] }],
  ...
  },
  {
    ...
    exhibit: {
      type: "cli",
      content: `R45# show interface fa0/0
FastEthernet0/0 is up, line protocol is up
Hardware is DEC21140, address is ca02.7788.0000 (bia ca02.7788.0000)
...
5 ]`,
  ...
  },
  {
    ...
    exhibit: {
      type: "cli",
      content: `R7# show interface fa0/0
FastEthernet0/0 is up, line protocol is up
Hardware is DEC21140, address is ca02.7788.0000 (bia ca02.7788.0000)
...
R    10.245.54.69/29 [120/13] via G0/4`,
  ...
  },
  {
    ...
    exhibit: {
      type: "cli",
      content: `R36# show interface fa0/0
FastEthernet0/0 is up, line protocol is up
Hardware is DEC21140, address is ca02.7788.0000 (bia ca02.7788.0000)
Description: sanfrancisco_subnet
Internet address is 10.32.102.2/30
...
5 ]`,
  ...
  },
  {
    ...
    exhibit: {
      type: "cli",
      content: `R9# show interface fa0/0
FastEthernet0/0 is up, line protocol is up
Hardware is DEC21140, address is ca02.7788.0000 (bia ca02.7788.0000)
Description: atlanta_subnet
Internet address is 10.32.102.2/30
...
Fa0/1                notconnect   1          a-full  a-100 10/100BaseTX`, highlight: ["FastEthernet0/1            unassigned      YES manual down       down"] },
  ...
  },
  {
    ...
    exhibit: {
      type: "cli",
      content: `R18# show interface fa0/0
FastEthernet0/0 is up, line protocol is up
Hardware is DEC21140, address is ca02.7788.0000 (bia ca02.7788.0000)
