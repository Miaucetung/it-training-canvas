...
// Source: ccna-classifier repo, commit 0323af0154aa0474269d7623fc0096292e9ff842

import type { ExhibitData } from "../types/exhibit";

export type CorrectAnswer = number | number[];
export type ExhibitField =
  | boolean
  | ExhibitData
  | ExhibitData[]
  | { needsExhibit: true; exhibitData: null };

export interface CCNAQuestionClassified {
  id: string;
  question: string;
  options: string[];
  correct: CorrectAnswer;
  exhibit: ExhibitField;
...
export const ccnaQuestionsClassified: CCNAQuestionClassified[] = [
  {
    "id": "Q0001",
  ...
  {
    "id": "Q0008",
    "question": "In which way does a spine-and-leaf architecture allow for scalability in a network when additional\naccess ports are required?",
    "options": [
  ...
  {
    "id": "Q0010",
    "question": "Which command automatically generates an IPv6 address from a specified IPv6 prefix and MAC\naddress of an interface?",
    "options": [
      "ipv6 address dhcp",
  ...
  {
    "id": "Q0013",
    "question": "What is the default behavior of a Layer 2 switch when a frame with an unknown destination MAC\naddress is received?",
    "options": [
  ...
  {
    "id": "Q0014",
    "question": "An engineer must configure a /30 subnet between two routes. Which usable IP address and subnet mask\ncombination meets this criteria?",
    "options": [
  ...
  {
    "id": "Q0024",
    "question": "Which action must be taken to assign a global unicast IPv6 address on an interface that is derived from\nthe MAC address of that interface?",
    "options": [
  ...
  {
    "id": "Q0025",
    "question": "Several new coverage cells are required to improve the Wi-Fi network of an organization. Which two\nstandard designs are recommended? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0035",
    "question": "Refer to the exhibit. An engineer must add a subnet for a new office that will add 20 users to the\nnetwork. Which IPv4 network and subnet mask combination does the engineer assign to minimize\nwasting addresses?",
    "options": [
    ...
    "exhibit": {
      ...
      "labels": [
        ...
        {
          "text": "10.10.225.16/28",
          "attachTo": "r2",
          "position": "below"
        },
        {
          "text": "10.10.225.64/26",
          "attachTo": "r3",
          "position": "below"
        },
        {
  ...
  {
    "id": "Q0037",
    "question": "An office has 8 floors with approximately 30-40 users per floor. One subnet must be used. Which\ncommand must be configured on the router Switched Virtual\nInterface to use address space efficiently?",
    "options": [
  ...
  {
    "id": "Q0039",
    "question": "A device detects two stations transmitting frames at the same time. This condition occurs after the first\n64 bytes of the frame is received. Which interface counter increments?",
    "options": [
      "runt",
      "collision",
      "late collision",
  ...
  {
    "id": "Q0040",
    "question": "Refer to the exhibit. Which outcome is expected when PC_A sends data to PC_B after their initial\ncommunication?",
    "options": [
  ...
  {
    "id": "Q0043",
    "question": "A wireless administrator has configured a WLAN; however, the clients need access to a less congested\n5-GHz network for their voice quality. Which action must be taken to meet the requirement?",
    "options": [
      "enable Band Select",
      "enable DTIM",
      "enable RX-SOP",
  ...
  {
    "id": "Q0053",
    "question": "Refer to the exhibit. A network technician is asked to design a small network with redundancy. The\nexhibit represents this design, with all hosts configured in the same VLAN. What conclusions can be\nmade about this design?",
    "options": [
  ...
  {
    "id": "Q0054",
    "question": "Which two statements are true about the command ip route 172.16.3.0 255.255.255.0 192.168.2.4?\n(Choose two.)",
    "options": [
  ...
  {
    "id": "Q0062",
    "question": "Refer to the exhibit. When PC1 sends a packet to PC2, the packet has which source and destination IP\naddress when it arrives at interface Gi0/0 on router R2?",
    "options": [
  ...
  {
    "id": "Q0068",
    "question": "What is a recommended approach to avoid co-channel congestion while installing access points that\nuse the 2.4 GHz frequency?",
    "options": [
  ...
  {
    "id": "Q0072",
    "question": "An engineer observes high usage on the 2.4GHz channels and lower usage on the 5GHz channels.\nWhat must be configured to allow clients to preferentially use 5GHz access points?",
    "options": [
      "Client Band Select",
  ...
  {
    "id": "Q0075",
    "question": "Refer to the exhibit. Shortly after SiteA was connected to SiteB over a new single-mode fiber path,\nusers at SiteA report intermittent connectivity issues with applications hosted at SiteB. What is the\ncause of the intermittent connectivity issue?",
    "options": [
  ...
  {
    "id": "Q0077",
    "question": "What is a network appliance that checks the state of a packet to determine whether the packet is\nlegitimate?",
    "options": [
      "Layer 2 switch",
      "LAN controller",
      "load balancer",
  ...
  {
    "id": "Q0079",
    "question": "An implementer is preparing hardware for virtualization to create virtual machines on a host. What is\nneeded to provide communication between hardware and virtual machines?",
    "options": [
      "router",
      "hypervisor",
      "switch",
  ...
  {
    "id": "Q0081",
    "question": "In which situation is private IPv4 addressing appropriate for a new subnet on the network of an\norganization?",
    "options": [
      ...
      "Traffic on the subnet must traverse a site-to-site VPN to an outside organization. 0082 #collapsedcore #threetier #threetier #collapsedcore"
    ],
    "correct": 2,
    "exhibit": false,
    "blueprint_section": "1.7",
  ...
  {
    "id": "Q0085",
    "question": "Refer to the exhibit. When PC-A sends traffic to PC-B, which network component is in charge of\nreceiving the packet from PC-A, verifying the IP addresses, and forwarding the packet to PC-B?",
    "options": [
      "router",
      "Layer 2 switch",
      "load balancer",
  ...
  },
  {
    ...
    "options": [
      ...
      "compare the destination IP address to the IP routing table Refer to the exhibit. R1 has just received a packet from host A that is destined to host B. Which route in the routing table is used by R1 to reach host B?",
  ...
  {
    "id": "Q0093",
    "question": "Refer to the exhibit. The link between PC1 and the switch is up, but it is performing poorly. Which\ninterface condition is causing the performance problem?",
    "options": [
  ...
  {
    "id": "Q0098",
    "question": "A network administrator is setting up a new IPv6 network using the 64-bit address\n2001:0EB8:00C1:2200:0001:0000:0000:0331/64. To simplify the configuration, the administrator has\ndecided to compress the address. Which IP address must the administrator configure?",
    "options": [
  ...
  {
    "id": "Q0101",
    "question": "Refer to the exhibit. An engineer is configuring the HO router. Which IPv6 address configuration must\nbe applied to the router fa0/1 interface for the router to assign a unique 64-bit IPv6 address to itself?",
    "options": [
  ...
  {
    "id": "Q0103",
    "question": "Refer to the exhibit. The given Windows PC is requesting the IP address of the host at www.cisco.com.\nTo which IP address is the request sent?",
    "options": [
      "192.168.1.253",
      "192.168.1.100",
      "192.168.1.226",
  ...
  {
    "id": "Q0105",
    "question": "Which type of IPv6 address is similar to a unicast address but is assigned to multiple devices on the\nsame network at the same time?",
    "options": [
  ...
  {
    "id": "Q0109",
    "question": "Refer to the exhibit. Each router must be configured with the last usable IP address in the subnet.\nWhich configuration fulfills this requirement?",
    "options": [
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "Fa0/0 - 10.19.63.80/28",
          "attachTo": "r7",
          "position": "below"
        },
        {
          "text": "Fa1/1 - 10.23.98.128/27",
          "attachTo": "r9",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0113",
    "question": "A network engineer is installing an IPv6-only capable device. The client has requested that the device\nIP address be reachable only from the internal network.\nWhich type of IPv6 address must the engineer assign?",
    "options": [
  ...
  {
    "id": "Q0115",
    "question": "A network engineer must implement an IPv6 configuration on the vlan 2000 interface to create a\nroutable locally-unique unicast address that is blocked from being advertised to the internet. Which\nconfiguration must the engineer apply?",
    "options": [
  ...
  {
    "id": "Q0123",
    "question": "Refer to the exhibit. Site A was recently connected to site B over a new single-mode fiber path. Users at\nsite A report intermittent connectivity issues with applications hosted at site B. What is the reason for\nthe problem?",
    "options": [
  ...
  },
  {
    ...
    "options": [
      ...
      "provides a boundary between Layer 2 and Layer 3 communications Q128 Which PoE mode enables powered-devices detection and guarantees power when the device detected?",
      "auto",
      "static",
      "dynamic",
      "active"
  ...
  {
    "id": "Q0129",
    "question": "Refer to the exhibit. The router has been configured with a super net to accommodate the requirements\nfor 380 users on a Subnet. The requirement already considers 30% future growth. Which configuration\nverifies the IP subnet on router R4?",
    "options": [
  ...
  {
    "id": "Q0130",
    "question": "Refer to the exhibit. Configurations for the switch and PCs are complete. Which configuration must be\napplied so that VLANs 2 and 3 communicate back and forth?",
    "options": [
  ...
  {
    "id": "Q0142",
    "question": "A network engineer must configure an interface with IP address 10.10.10.145 and a subnet mask\nequivalent to 11111111.11111111.11111111.11111000. Which subnet mask must the engineer use?",
    "options": [
      "/29",
      "/30",
      "/27",
  ...
  {
    "id": "Q0143",
    "question": "Refer to the exhibit. The switches are connected via a Cat5 Ethernet cable that is tested successfully.\nThe interfaces are configured as access ports and are both in a down status. What is the cause of the\nissue?",
    "options": [
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "Speed 100 - Duplex Half",
          "attachTo": "a",
          "position": "below"
        },
        {
          "text": "Speed 10 - Duplex Half",
          "attachTo": "b",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0144",
    "question": "Which two IP addressing schemes provide internet access to users on the network while preserving the\npublic IPv4 address space? (Choose two.)",
    "options": [
      "IPv6 addressing",
  ...
  {
    "id": "Q0161",
    "question": "Which two cable types must be used to connect an access point to the WLC when 2.5-Gbps and 5-Gbps\nupload speeds are required? (Choose two.)",
    "options": [
      "10GBASE-T",
      "1000BASE-LX/LH",
      "Cat 5e",
  ...
  {
    "id": "Q0163",
    "question": "An engineer must update the configuration on two PCs in two different subnets to communicate locally\nwith each other. One PC is configured with IP address\n192.168.25.128/25 and the other with 192.168.25.100/25. Which network mask must the engineer\nconfigure on both PCs to enable the communication?",
    "options": [
      "255.255.255.248",
      "255.255.255.224",
      "255.255.255.0",
  ...
  {
    "id": "Q0166",
    "question": "Refer to the exhibit. An engineer assigns IP addressing to the current VLAN with three PCs. The\nconfiguration must also account for the expansion of 30 additional\nVLANS using the same Class C subnet for subnetting and host count. Which command set fulfills the\nrequest while reserving address space for the expected growth?",
    "options": [
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "Class-C-Netz, + 30 weitere VLANs",
          "attachTo": "sw",
          "position": "above"
        }
      ]
  ...
  {
    "id": "Q0167",
    "question": "A client experiences slow throughput from a server that is directly connected to the core switch in a\ndata center. A network engineer finds minimal latency on connections to the server, but data transfers\nare unreliable, and the output of the show interfaces counters errors command shows a high FCS-Err\ncount on the interface that is connected to the server. What is the cause of the throughput issue?",
    "options": [
  ...
  {
    "id": "Q0171",
    "question": "What is the path for traffic sent from one user workstation to another workstation on a separate switch\nin a three-tier architecture model?",
    "options": [
  ...
  {
    "id": "Q0173",
    "question": "Refer to the exhibit. Between which zones do wireless users expect to experience intermittent\nconnectivity?",
    "options": [
  ...
  },
  {
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "0C:E0:38:41:86:07",
          "attachTo": "sw1",
          "position": "above"
        },
        {
          "text": "0C:0E:15:22:05:97",
          "attachTo": "sw2",
          "position": "left"
        },
        {
          "text": "0C:0E:15:1A:3C:9D",
          "attachTo": "sw3",
          "position": "right"
        },
        {
          "text": "0C:E0:18:1A:1B:19",
          "attachTo": "sw4",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0183",
    "question": "An engineer needs to configure LLDP to send the port description type length value (TLV). Which\ncommand sequence must be implemented?",
    "options": [
  ...
  },
  {
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "Prio 32768 / 00:00:00:00:00:00",
          "attachTo": "s4",
          "position": "above"
        },
        {
          "text": "Prio 32768 / AA:AA:AA:AA:AA:AA",
          "attachTo": "s1",
          "position": "left"
        },
        {
          "text": "Prio 30000 / CC:CC:CC:CC:CC:CC",
          "attachTo": "s3",
          "position": "right"
        },
        {
          "text": "Prio 30000 / BB:BB:BB:BB:BB:BB",
          "attachTo": "s2",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0186",
    "question": "Refer to the exhibit. After the switch configuration, the ping test fails between PC A and PC B. Based\non the output for switch 1, which error must be corrected?",
    "options": [
  ...
  {
    "id": "Q0188",
    "question": "Which unified access point mode continues to serve wireless clients after losing connectivity to the\nCisco Wireless LAN Controller?",
    "options": [
      "local",
      "mesh",
      "flexconnect",
  ...
  {
    "id": "Q0190",
    "question": "Which mode must be used to configure EtherChannel between two switches without using a\nnegotiation protocol?",
    "options": [
      "active",
      "on",
      "auto",
  ...
  {
    "id": "Q0192",
    "question": "Which two values or settings must be entered when configuring a new WLAN in the Cisco Wireless\nLAN Controller GUI? (Choose two.)",
    "options": [
      "QoS settings",
  ...
  {
    "id": "Q0195",
    "question": "Refer to the exhibit. Based on the LACP neighbor status, in which mode is the SW1 port channel\nconfigured?",
    "options": [
      "mode on",
      "active",
      "passive",
  ...
  {
    "id": "Q0196",
    "question": "Two switches are connected and using Cisco Dynamic Trunking Protocol. SW1 is set to Dynamic Auto\nand SW2 is set to Dynamic Desirable. What is the result of this configuration?",
    "options": [
  ...
  {
    "id": "Q0197",
    "question": "A Cisco IP phone receives untagged data traffic from an attached PC. Which action is taken by the\nphone?",
    "options": [
  ...
  {
    "id": "Q0199",
    "question": "Refer to the exhibit. The network administrator wants VLAN 67 traffic to be untagged between Switch\n1 and Switch 2, while all other VLANs are to remain tagged.\nWhich command accomplishes this task?",
    "options": [
  ...
  {
    "id": "Q0200",
    "question": "Which two command sequences must be configured on a switch to establish a Layer 3 EtherChannel\nwith an open-standard protocol? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0202",
    "question": "What is the expected outcome when a Cisco phone is connected to the\nGigabitEthernet 3/1/4 port on a switch?",
    "options": [
  ...
  {
    "id": "Q0203",
    "question": "Refer to the exhibit. Which action is expected from SW1 when the untagged frame is received on the\nGigabitEthernet0/1 interface?",
    "options": [
  ...
  {
    "id": "Q0206",
    "question": "In a CDP environment, what happens when the CDP interface on an adjacent device is configured\nwithout an IP address?",
    "options": [
  ...
  {
    "id": "Q0208",
    "question": "When configuring an EtherChannel bundle, which mode enables LACP only if a LACP device is\ndetected?",
    "options": [
      "Passive",
      "Desirable",
      "On",
  ...
  {
    "id": "Q0211",
    "question": "Which two pieces of information about a Cisco device can Cisco Discovery Protocol communicate?\n(Choose two.)",
    "options": [
      "the native VLAN",
  ...
  {
    "id": "Q0212",
    "question": "After you deploy a new WLAN controller on your network, which two additional tasks should you\nconsider? (Choose two.)",
    "options": [
  ...
  },
  {
    ...
    "options": [
      ...
      "channel-group 10 mode active Q215 How does STP prevent forwarding loops at OSI Layer 2?",
      "TTL",
  ...
  },
  {
    ...
    "options": [
      ...
      "It runs on the physical layer and the data link layer. What are two reasons a network administrator would use CDP? (Choose two.)",
  ...
  {
    "id": "Q0223",
    "question": "On a corporate network, hosts on the same VLAN can communicate with each other, but they are\nunable to communicate with hosts on different VLANs. What is needed to allow communication\nbetween the VLANs?",
    "options": [
  ...
  {
    "id": "Q0230",
    "question": "A network engineer must create a diagram of a multivendor network. Which command must be\nconfigured on the Cisco devices so that the topology of the network is allowed to be mapped?",
    "options": [
  ...
  {
    "id": "Q0234",
    "question": "The SW1 interface g0/1 is in the down/down state. What are two reasons for the interface condition?\n(Choose two.)",
    "options": [
  ...
  {
    "id": "Q0236",
    "question": "Which two conditions must be met before SSH operates normally on a Cisco IOS switch? (Choose\ntwo.)",
    "options": [
  ...
  {
    "id": "Q0239",
    "question": "Which protocol prompts the Wireless LAN Controller to generate its own local web administration SSL\ncertificate for GUI access?",
    "options": [
      "RADIUS",
      "HTTPS",
      "TACACS+",
      "HTTP Q240 An engineer must configure interswitch VLAN communication between a Cisco switch and a third- party switch. Which action should be taken?",
      "configure DSCP",
  ...
  {
    "id": "Q0241",
    "question": "An engineer requires a switch interface to actively attempt to establish a trunk link with a neighbor\nswitch. What command must be configured?",
    "options": [
      "switchport mode trunk",
  ...
  },
  {
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "0C:E0:38:81:32:58",
          "attachTo": "s1",
          "position": "left"
        },
        {
          "text": "0C:0E:15:22:1A:61",
          "attachTo": "s2",
          "position": "right"
        },
        {
          "text": "0C:0E:15:1D:3C:9A",
          "attachTo": "s3",
          "position": "left"
        },
        {
          "text": "0C:E0:19:A1:4D:16",
          "attachTo": "s4",
          "position": "right"
        }
      ]
  ...
  {
    "id": "Q0243",
    "question": "An engineer must establish a trunk link between two switches. The neighboring switch is set to trunk or\ndesirable mode. What action should be taken?",
    "options": [
  ...
  {
    "id": "Q0244",
    "question": "Which spanning-tree enhancement avoids the learning and listening states and immediately places ports\nin the forwarding state?",
    "options": [
      "BPDUfilter",
      "PortFast",
      "Backbonefast",
  ...
  {
    "id": "Q0246",
    "question": "When using Rapid PVST+, which command guarantees the switch is always the root bridge for VLAN\n200?",
    "options": [
  ...
  {
    "id": "Q0247",
    "question": "Refer to the exhibit. Which command must be executed for Gi1/1 on SW1 to passively become a trunk\nport if Gi1/1 on SW2 is configured in desirable or trunk mode?",
    "options": [
      "switchport mode dynamic auto",
  ...
  {
    "id": "Q0248",
    "question": "Refer to the exhibit. The entire contents or the MAC address table are shown. Sales-4 sends a data\nframe to Sales-1.\nWhat does the switch do as it receives the frame from Sales-4?",
    "options": [
  ...
  {
    "id": "Q0249",
    "question": "Refer to the exhibit. An engineer must configure GigabitEthernet1/1 to accommodate voice and data\ntraffic. Which configuration accomplishes this task?",
    "options": [
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "VLAN 300 = Data - VLAN 400 = Voice",
          "attachTo": "ph",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0250",
    "question": "An engineer needs to add an old switch back into a network. To prevent the switch from corrupting the\nVLAN database, with action must be taken?",
    "options": [
  ...
  {
    "id": "Q0251",
    "question": "Which technology prevents client devices from arbitrarily connecting to the network without state\nremediation?",
    "options": [
      "802.11n",
      "802.1x",
  ...
  {
    "id": "Q0253",
    "question": "An administrator must secure the WLC from receiving spoofed association requests. Which steps must\nbe taken to configure the WLC to restrict the requests and force the user to wait 10 ms to retry an\nassociation request?",
    "options": [
  ...
  },
  {
    ...
    "exhibit": {
      ...
      "labels": [
        ...
        {
          "text": "Prio niedrigste (permanent)",
          "attachTo": "b3",
          "position": "below"
        },
        {
          "text": "root primary (nicht permanent)",
          "attachTo": "b4",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0255",
    "question": "An engineer must configure traffic for a VLAN that is untagged by the switch as it crosses a trunk link.\nWhich command should be used?",
    "options": [
      "switchport trunk encapsulation dot1q",
  ...
  {
    "id": "Q0260",
    "question": "An engineer configures interface Gi1/0 on the company PE router to connect to an ISP. Neighbor\ndiscovery is disabled.\nWhich action is necessary to complete the configuration if the ISP uses third-party network devices?\nQ0261 Nachfragen",
    "options": [
      "Disable autonegotiation.",
      "Enable LLDP globally.",
      "Enable LLDP-MED on the ISP device.",
      "Disable Cisco Discovery Protocol on the interface. used. BPDUS received are forwarded to the system module Frames received from the attached segment are processed Switched frames received from other ports are advanced The port in the forwarding state responds to network management messages"
    ],
    "correct": 1,
    "exhibit": false,
    "blueprint_section": "2.3",
  ...
  {
    "id": "Q0262",
    "question": "Which access point mode relies on a centralized controller for management, roaming, and SSID\nconfiguration?",
    "options": [
      "lightweight mode",
      "autonomous mode",
      "bridge mode",
  ...
  {
    "id": "Q0263",
    "question": "Refer to the exhibit. A network engineer must configure communication between PC A and the File\nServer. To prevent interruption for any other communications, which command must be configured?",
    "options": [
    ...
    "exhibit": [
      {
        ...
        "labels": [
          {
            "text": "192.168.0.10/23",
            "attachTo": "pca",
            "position": "above"
          },
          {
            "text": "192.168.1.20/23",
            "attachTo": "fs",
            "position": "above"
          }
        ]
  ...
  },
  {
    ...
    "options": [
      ...
      "DHCP snooping",
      "802.1x",
      "using a non-default native VLAN Refer to the exhibit. Which action do the switches take on the trunk link?",
  ...
  {
    "id": "Q0267",
    "question": "A network engineer must configure two new subnets using the address block 10.70.128.0/19 to meet\nthese requirements:\n✑ The first subnet must support 24 hosts.\n✑ The second subnet must support 472 hosts.\n✑ Both subnets must use the longest subnet mask possible from the address block.\nWhich two configurations must be used to configure the new subnets and meet a requirement to use the\nfirst available address in each subnet for the router interfaces? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0268",
    "question": "Refer to the exhibit. An administrator must configure interfaces Gi1/1 and Gi1/3 on switch SW11. PC-1\nand PC-2 must be placed in the Data VLAN, and Phone-1 must be placed in the Voice VLAN. Which\nconfiguration meets these requirements?",
    "options": [
  ...
  {
    "id": "Q0269",
    "question": "Refer to the exhibit. Users need to connect to the wireless network with IEEE 802.11r-compatible\ndevices. The connection must be maintained as users travel between floors or to other areas in the\nbuilding. What must be the configuration of the connection?",
    "options": [
  ...
  {
    "id": "Q0270",
    "question": "Refer to the exhibit. An engineer is asked to insert the new VLAN into the existing trunk without\nmodifying anything previously configured. Which command accomplishes this task?",
    "options": [
  ...
  {
    "id": "Q0271",
    "question": "Aside from discarding, which two states does the switch port transition through while using RSTP\n(802.1w)? (Choose two.)\nQ0272 #autonomousaccesspoint #cloudbasedaccesspoint",
    "options": [
      "blocking",
      "speaking",
      "listening",
      "learning",
      "forwarding AAP = Requires and Accessible CBAP = Support und managed"
    ],
    "correct": [
      3,
      4
  ...
  {
    "id": "Q0275",
    "question": "Refer to the exhibit. The network administrator must prevent the switch Cat9K-2 IP address from being\nvisible in LLDP without disabling the protocol. Which action must be taken to complete the task?",
    "options": [
  ...
  {
    "id": "Q0276",
    "question": "Refer to the exhibit. An engineer has started to configure replacement switch SW1. To verify part of the\nconfiguration, the engineer issued the commands as shown and noticed that the entry for PC2 is\nmissing. Which change must be applied to SW1 so that PC1 and PC2 communicate normally?",
    "options": [
    ...
    "exhibit": [
      {
        ...
        "labels": [
          {
            "text": "VLAN 2 - 0007.ec53.4289",
            "attachTo": "pc1",
            "position": "above"
          },
          {
            "text": "VLAN 2 - 0007.ec89.7513",
            "attachTo": "pc2",
            "position": "above"
          }
        ]
  ...
  },
  {
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "BID 32778 0018.184e.3c00",
          "attachTo": "s1",
          "position": "left"
        },
        {
          "text": "BID 24586 001a.e3ff.a680",
          "attachTo": "s2",
          "position": "right"
        },
        {
          "text": "BID 28682 0022.55cf.cc00",
          "attachTo": "s3",
          "position": "left"
        },
        {
          "text": "BID 64000 4e15.8403.08f",
          "attachTo": "s4",
          "position": "right"
        }
      ]
  ...
  {
    "id": "Q0279",
    "question": "Refer to the exhibit. An engineer is configuring a Layer 3 port-channel interface with LACP. The\nconfiguration on the first device is complete, and it is verified that both interfaces have registered the\nneighbor device in the CDP table. Which task on the neighbor device enables the new port channel to\ncome up without negotiating the channel?",
    "options": [
  ...
  {
    "id": "Q0280",
    "question": "Refer to the exhibit. Which configuration establishes a Layer 2 LACP EtherChannel when applied to\nboth switches?",
    "options": [
  ...
  {
    "id": "Q0282",
    "question": "Refer to the exhibit. Which action must be taken so that neighboring devices rapidly discover switch\nCat9300?",
    "options": [
  ...
  {
    "id": "Q0285",
    "question": "Which type of port is used to connect the wired network when an autonomous AP maps two VLANs to\nits WLANs?",
    "options": [
      "access",
      "LAG",
      "trunk",
  ...
  {
    "id": "Q0286",
    "question": "A network administrator needs to aggregate 4 ports into a single logical link which must negotiate layer\n2 connectivity to ports on another switch. What must be configured when using active mode on both\nsides of the connection?",
    "options": [
      "LLDP",
      "LACP",
      "Cisco vPC",
  ...
  {
    "id": "Q0287",
    "question": "Refer to the exhibit. An engineer built a new L2 LACP EtherChannel between SW1 and SW2 and\nexecuted these show commands to verify the work establish an\nLACP port channel?",
    "options": [
  ...
  {
    "id": "Q0292",
    "question": "Refer to the exhibit. Which change to the configuration on Switch2 allows the two switches to establish\nan EtherChannel?",
    "options": [
  ...
  {
    "id": "Q0293",
    "question": "Refer to the exhibit. An engineer must configure the interface that connects to PC1 and secure it in a\nway that only PC1 is allowed to use the port. No VLAN tagging can be used except for a voice VLAN.\nWhich command sequence must be entered to configure the switch?",
    "options": [
  ...
  {
    "id": "Q0294",
    "question": "Which protocol must be implemented to support separate authorization and authentication solutions for\nwireless APs?",
    "options": [
      "RADIUS",
      "TACACS+",
      "802.1X",
  ...
  {
    "id": "Q0299",
    "question": "Refer to the exhibit. The EtherChannel is configured with a speed of 1000 and duplex as full on both\nends of channel group 1. What is the next step to configure the channel on switch A to respond to but\nnot initiate LACP communication?",
    "options": [
      ...
      "links": [
        {
          "from": "swa",
          "to": "swb",
          "subnet": "EtherChannel (Gruppe 1)",
          "labelFrom": "Ge0/0/0-0/15",
          "labelTo": "Ge0/0/0-0/15"
        },
        {
          "from": "swa",
          "to": "ha"
  ...
  {
    "id": "Q0300",
    "question": "Which command entered on a switch configured with Rapid PVST+ listens and learns for a specific\ntime period?",
    "options": [
  ...
  {
    "id": "Q0301",
    "question": "What must a network administrator consider when deciding whether to configure a new wireless\nnetwork with APs in autonomous mode or APs running in cloud- based mode?",
    "options": [
  ...
  {
    "id": "Q0306",
    "question": "Refer to the exhibit. Switch AccSw1 has just been added to the network along with PC2. All VLANs\nhave been implemented on AccSw2. How must the ports on\nAccSw2 be configured to establish Layer 2 connectivity between PC1 and PC2?",
    "options": [
  ...
  {
    "id": "Q0307",
    "question": "Refer to the exhibit. A network engineer must update the configuration on Switch2 so that it sends\nLLDP packets every minute and the information sent via LLDP is refreshed every 3 minutes. Which\nconfiguration must the engineer apply?",
    "options": [
  ...
  {
    "id": "Q0308",
    "question": "Refer to the exhibit. Switch A is newly configured. All VLANs are present in the VLAN database. The\nIP phone and PC A on Gi0/1 must be configured for the appropriate VLANs to establish connectivity\nbetween the PCs. Which command set fulfills the requirement?",
    "options": [
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "Data VLAN 50 - Voice VLAN 51",
          "attachTo": "swa",
          "position": "above"
        }
      ]
  ...
  {
    "id": "Q0309",
    "question": "Refer to the exhibit. Two new switches are being installed. The remote monitoring team uses the\nsupport network to monitor both switches. Which configuration is the next step to establish a Layer 2\nconnection between the two PCs?",
    "options": [
  ...
  {
    "id": "Q0311",
    "question": "Which WLC interface provides out-of-band management in the Cisco Unified Wireless Network\nArchitecture?",
    "options": [
      "AP-Manager",
      "service port",
      "dynamic",
      "virtual Q312 Refer to the exhibit. The network engineer is configuring a new WLAN and is told to use a setup password for authentication instead of the RADIUS servers. Which additional set of tasks must the engineer perform to complete the configuration?",
      ...
      "Select WPA2 Policy Disable PMF Enable PSK Q313 Which mode must be set for Aps to communicate to a Wireless LAN Controller using the Control and Provisioning of Wireless Access Points (CAPWAP) protocol?",
      "route",
      "bridge",
      "lightweight",
      "autonomous Q314 Which switch technology establishes a network connection immediately when it is plugged in?",
      "PortFast",
      "BPDU guard",
      "UplinkFast",
      "BackboneFast Q315 Which command on a port enters the forwarding state immediately when a PC is connected to it?",
      "switch(config)#spanning-tree portfast default",
      "switch(config)#spanning-tree portfast bpduguard default",
      "switch(config-if)#spanning-tree portfast trunk",
      "switch(config-if)#no spanning-tree portfast Q316 If a switch port receives a new frame while it is actively transmitting a previous frame, how does it process the frames?",
      ...
      "The two frames are processed and delivered at the same time Q317 Refer to the exhibit. The entire MAC address table for SW1 is shown here: What does SW1 do when Br-4 sends a frame for Br-2",
  ...
  {
    "id": "Q0318",
    "question": "Which statement about Link Aggregation when implemented on a Cisco Wireless LAN Controller is\ntrue?",
    "options": [
      "To pass client traffic two or more ports must be configured",
      "The EtherChannel must be configured in ג€mode activeג€",
      "When enabled, the WLC bandwidth drops to 500 Mbps",
  ...
  {
    "id": "Q0322",
    "question": "Refer to the exhibit. Which switch becomes the root of a spanning tree for VLAN 10 if the primary\nswitch fails and all links are of equal speed?",
    "options": [
      "SW1",
      "SW2",
      "SW3",
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "32778 0018.1843.3cb0",
          "attachTo": "sw1",
          "position": "left"
        },
        {
          "text": "24586 004a.13e9.3912",
          "attachTo": "sw2",
          "position": "right"
        },
        {
          "text": "28682 0022.55cf.cc00",
          "attachTo": "sw3",
          "position": "below"
        },
        {
          "text": "64000 0022.66ed.a29f",
          "attachTo": "sw4",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0325",
    "question": "Which channel-group mode must be configured when multiple distribution interfaces connected to a\nWLC are bundled?",
    "options": [
  ...
  {
    "id": "Q0327",
    "question": "Which Layer 2 switch function encapsulates packets for different VLANs so that the packets transverse\nthe same port and maintain traffic separation between the\nVLANs?",
    "options": [
      "VLAN marking",
      "VLAN numbering",
      "VLAN DSCP",
  ...
  {
    "id": "Q0328",
    "question": "Which value is the unique identifier that an access point uses to establish and maintain wireless\nconnectivity to wireless network devices?",
    "options": [
      "VLAN ID",
      "(B)SSID",
      "RFID",
  ...
  {
    "id": "Q0332",
    "question": "What does a switch do when it receives a frame whose destination MAC address is missing from the\nMAC address table?",
    "options": [
  ...
  {
    "id": "Q0333",
    "question": "By default, how long will the switch continue to know a workstation MAC address after the\nworkstation stops sending traffic?",
    "options": [
      "200 seconds",
      "300 seconds",
      "600 seconds",
  ...
  {
    "id": "Q0334",
    "question": "A project objective is to minimize the association time to the different access points as mobile devices\nmove around the office. The ideal solution must cover numerous devices and device types, including\nlaptops, mobile phones, tablets and wireless printers. What must be configured?",
    "options": [
  ...
  {
    "id": "Q0335",
    "question": "Which two protocols are used by an administrator for authentication and configuration on access\npoints? (Choose two.)",
    "options": [
      "802.1Q",
      "RADIUS",
      "Kerberos",
      "TACACS+",
      "802.1x Q 0336 Nachfragen #monitorsensorsniffer #monitor #sensor #sniffer Monitor It enables RFID-tag location tracking It supports software that analyzes wireless frames on a remote device Sensor it supports real-time wi-fi client troubleshooting when network engineers are offsite It supports analytics for wireless performance testing Sniffer it captures and forwards packets on a specific wireless channel It enables air-quality data and interference detection across all enabled devices"
    ],
    "correct": [
      1,
      3
  ...
  {
    "id": "Q0337",
    "question": "A WLC sends alarms about a rogue AP, and the network administrator verifies that the alarms are\ncaused by a legitimate autonomous AP. How must the alarms be stopped for the MAC address of the\nAP?",
    "options": [
  ...
  {
    "id": "Q0339",
    "question": "When an access point is seeking to join wireless LAN controller, which message is sent to the AP-\nManager interface?",
    "options": [
      "Discovery response",
      "DHCP request",
      "DHCP discover",
  ...
  {
    "id": "Q0340",
    "question": "Refer to the exhibit. A network engineer configures the Cisco WLC to authenticate local wireless\nclients against a RADIUS server. Which task must be performed to complete the process?",
    "options": [
    ...
    "exhibit": {
      "type": "table",
      "headers": [
        "RADIUS Authentication Server (New)",
        "Wert"
      ],
      "rows": [
        [
  ...
  {
    "id": "Q0341",
    "question": "After installing a new Cisco ISE server which task must the engineer perform on the Cisco WLC to\nconnect wireless clients on a specific VLAN based on their credentials?",
    "options": [
  ...
  {
    "id": "Q0342",
    "question": "Refer to the exhibit. Router R1 is running three different routing protocols. Which route characteristic\nis used by the router to forward the packet that it receives for destination IP 172.16.32.1?",
    "options": [
      "longest prefix",
  ...
  {
    "id": "Q0343",
    "question": "Refer to the exhibit. Router R1 Fa0/0 cannot ping router R3 Fa0/1. Which action must be taken in\nrouter R1 to help resolve the configuration issue?",
    "options": [
  ...
  {
    "id": "Q0345",
    "question": "Router R1 must send all traffic without a matching routing-table entry to 192.168.1.1. Which\nconfiguration accomplishes this task?",
    "options": [
  ...
  {
    "id": "Q0350",
    "question": "Refer to the exhibit. A router received these five routes from different routing information sources.\nWhich two routes does the router install in its routing table?\n(Choose two.)",
    "options": [
  ...
  {
    "id": "Q0353",
    "question": "Which two minimum parameters must be configured on an active interface to enable OSPFV2 to\noperate? (Choose two.)",
    "options": [
      "OSPF process ID",
  ...
  {
    "id": "Q0354",
    "question": "Refer to the exhibit. What commands are needed to add a sub-interface to Ethernet0/0 on R1 to allow\nfor VLAN 20, with IP address 10.20.20.1/24?",
    "options": [
  ...
  {
    "id": "Q0356",
    "question": "Refer to the exhibit. The loopback1 interface of the Atlanta router must reach the loopback3 interface\nof the Washington router. Which two static host routes must be configured on the New York router?\n(Choose two.)",
    "options": [
  ...
  {
    "id": "Q0357",
    "question": "Refer to the exhibit. After the configuration is applied, the two routers fail to establish an OSPF\nneighbor relationship. What is the reason for the problem?",
    "options": [
  ...
  {
    "id": "Q0361",
    "question": "When a floating static route is configured, which action ensures that the backup route is used when the\nprimary route fails?",
    "options": [
  ...
  {
    "id": "Q0362",
    "question": "Refer to the exhibit. The show ip ospf interface command has been executed on R1. How is OSPF\nconfigured?",
    "options": [
  ...
  {
    "id": "Q0363",
    "question": "A user configured OSPF and advertised the Gigabit Ethernet interface in OSPF. By default, to which\ntype of OSPF network does this interface belong?",
    "options": [
      "point-to-multipoint",
      "point-to-point",
      "broadcast",
  ...
  {
    "id": "Q0364",
    "question": "Which attribute does a router use to select the best path when two or more different routes to the same\ndestination exist from two different routing protocols?",
    "options": [
      "dual algorithm",
      "metric",
      "administrative distance",
  ...
  {
    "id": "Q0365",
    "question": "Router A learns the same route from two different neighbors; one of the neighbor routers is an OSPF\nneighbor, and the other is an EIGRP neighbor.\nWhat is the administrative distance of the route that will be installed in the routing table?\nQ0366 Nachfragen CCNA?",
    "options": [
      "20",
      "90",
      "110",
      "115 Refer to the exhibit. An engineer is bringing up a new circuit to the MPLS provider on the Gi0/1 interface of Router 1. The new circuit uses eBGP and learns the route to VLAN25 from the BGP path. What is the expected behavior for the traffic flow for route 10.10.13.0/25?",
      "Traffic to 10.10.13.0/25 is load balanced out of multiple interfaces.",
      "Traffic to 10.10.13.0/25 is asymmetrical.",
      "Route 10.10.13.0/25 is updated in the routing table as being learned from interface Gi0/1. Jonny",
  ...
  {
    "id": "Q0368",
    "question": "Refer to the exhibit. If OSPF is running on this network, how does Router2 handle traffic from Site B\nto 10.10.13.128/25 at Site A?",
    "options": [
  ...
  {
    "id": "Q0370",
    "question": "Refer to the exhibit. An engineer is configuring the New York router to reach the Lo1 interface of the\nAtlanta router using interface Se0/0/0 as the primary path.\nWhich two commands must be configured on the New York router so that it reaches the Lo1 interface\nof the Atlanta router via Washington when the link between\nNew York and Atlanta goes down? (Choose two.)",
    "options": [
      "Ipv6 route 2000::1/128 2012::1",
  ...
  {
    "id": "Q0372",
    "question": "Refer to the exhibit. Which action establishes the OSPF neighbor relationship without forming an\nadjacency?",
    "options": [
  ...
  {
    "id": "Q0373",
    "question": "Which command must you enter to guarantee that an HSRP router with higher priority becomes the\nHSRP primary router after it is reloaded?",
    "options": [
      "standby 10 preempt",
  ...
  {
    "id": "Q0375",
    "question": "Refer to the exhibit. Which command would you use to configure a static route on Router1 to network\n192.168.202.0/24 with a nondefault administrative distance?",
    "options": [
    ...
    "exhibit": {
      ...
      "links": [
        ...
        },
        {
          "from": "r1",
          "to": "pc1",
          "labelFrom": "LAN 192.168.200.0/24"
        },
        {
          "from": "r2",
          "to": "pc2",
          "labelFrom": "LAN 192.168.202.0/24"
        }
      ],
      "labels": [
        {
          "text": "192.168.200.226",
          "attachTo": "pc1",
          "position": "below"
        },
        {
          "text": "192.168.202.129",
          "attachTo": "pc2",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0377",
    "question": "You have configured a router with an OSPF router ID, but its IP address still reflects the physical\ninterface.\nWhich action can you take to correct the problem in the least disruptive way?",
    "options": [
  ...
  {
    "id": "Q0379",
    "question": "Refer to the exhibit. Router R1 must be configured to reach the 10.0.3.0/24 network from the\n10.0.1.0/24 segment. Which command must be used to configure the route?",
    "options": [
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "LAN 10.0.1.0/24",
          "attachTo": "r1",
          "position": "above"
        },
        {
          "text": "LAN 10.0.2.0/24",
          "attachTo": "r2",
          "position": "above"
        },
        {
          "text": "LAN 10.0.3.0/24",
          "attachTo": "r3",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0380",
    "question": "Refer to the exhibit. Which two statements about the network environment of router R1 must be true?\n(Choose two.)",
    "options": [
  ...
  {
    "id": "Q0384",
    "question": "Which two circumstances can prevent two routers from establishing an OSPF neighbor adjacency?\n(Choose two.)",
    "options": [
  ...
  {
    "id": "Q0386",
    "question": "Refer to the exhibit. If R1 receives a packet destined to 172.16.1.1, to which IP address does it send the\npacket?",
    "options": [
      "192.168.14.4",
      "192.168.12.2",
      "192.168.13.3",
  ...
  {
    "id": "Q0392",
    "question": "Which configuration command can you apply to a HSRP router so that its local interface becomes\nactive if all other routers in the group fail?",
    "options": [
  ...
  {
    "id": "Q0396",
    "question": "Refer to the exhibit. After you apply the given configurations to R1 and R2 you notice that OSPFv3\nfails to start.",
    "options": [
  ...
  {
    "id": "Q0399",
    "question": "Refer to the exhibit. C-router is to be used as a \"router-on-a-stick\" to route between the VLANs. All the\ninterfaces have been properly configured and IP routing is operational. The hosts in the VLANs have\nbeen configured with the appropriate default gateway. What is true about this configuration?",
    "options": [
  ...
  {
    "id": "Q0400",
    "question": "Refer to the exhibit. Which address and mask combination represents a summary of the routes learned\nby EIGRP?",
    "options": [
  ...
  {
    "id": "Q0401",
    "question": "Refer to the exhibit. Given the output for this command, if the router ID has not been manually set,\nwhat router ID will OSPF use for this router?",
    "options": [
      "10.1.1.2",
      "10.154.154.1",
      "172.16.5.1",
  ...
  {
    "id": "Q0403",
    "question": "A network administrator is troubleshooting the OSPF configuration of routers R1 and R2. The routers\ncannot establish an adjacency relationship on their common\nEthernet link.\nThe graphic shows the output of the show ip ospf interface e0 command for routers R1 and R2. Based\non the information in the graphic, what is the cause of this problem?",
    "options": [
  ...
  {
    "id": "Q0404",
    "question": "Refer to the exhibit. Which two statements are true about the loopback address that is configured on\nRouterB? (Choose two.)",
    "options": [
      ...
      "links": [
        {
          "from": "ra",
          "to": "sw",
          "labelFrom": "192.168.1.1"
        },
        {
          "from": "rb",
          "to": "sw",
          "labelFrom": "192.168.1.2"
        },
        {
          "from": "rc",
          "to": "sw",
          "labelFrom": "192.168.1.3"
        },
        {
          "from": "rd",
          "to": "sw",
          "labelFrom": "192.168.1.4"
        }
      ],
      "labels": [
        {
  ...
  {
    "id": "Q0405",
    "question": "If all OSPF routers in a single area are configured with the same priority value, what value does a\nrouter use for the OSPF router ID in the absence of a loopback interface?",
    "options": [
  ...
  {
    "id": "Q0410",
    "question": "An engineer must configure an OSPF neighbor relationship between router R1 and R3. The\nauthentication configuration has been configured and the connecting interfaces are in the same\n192.168.1.0/30 subnet. What are the next two steps to complete the configuration? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0411",
    "question": "Refer to the exhibit. A packet is being sent across router R1 to host 172.16.0.14. What is the destination\nroute for the packet?",
    "options": [
  ...
  {
    "id": "Q0412",
    "question": "Refer to the exhibit. A packet is being sent across router R1 to host 172.16.3.14. To which destination\ndoes the router send the packet?",
    "options": [
  ...
  {
    "id": "Q0413",
    "question": "Refer to the exhibit. Router R2 is configured with multiple routes to reach network 10.1.1.0/24 from\nrouter R1. Which path is chosen by router R2 to reach the destination network 10.1.1.0/24?",
    "options": [
      "static",
      "EIGRP",
      "eBGP",
  ...
  {
    "id": "Q0415",
    "question": "Refer to the exhibit. A network administrator assumes a task to complete the connectivity between PC\nA and the File Server. Switch A and Switch B have been partially configured with VLANs 10, 11, 12,\nand 13. What is the next step in the configuration?",
    "options": [
  ...
  {
    "id": "Q0417",
    "question": "R1 has learned route 192.168.12.0/24 via IS-IS, OSPF, RIP, and Internal EIGRP. Under normal\noperating conditions, which routing protocol is installed in the routing table?",
    "options": [
      "IS-IS",
      "Internal EIGRP",
      "RIP",
  ...
  {
    "id": "Q0418",
    "question": "Refer to the exhibit. The default-information originate command is configured under the R1 OSPF\nconfiguration. After testing, workstations on VLAN 20 at Site\nB cannot reach a DNS server on the Internet.\nWhich action corrects the configuration issue?",
    "options": [
  ...
  {
    "id": "Q0420",
    "question": "A user configured OSPF in a single area between two routers. A serial interface connecting R1 and R2\nis running encapsulation PPP. By default, which OSPF network type is seen on this interface when the\nuser types show ip ospf interface on R1 or R2?",
    "options": [
      "nonbroadcast",
      "point-to-point",
      "point-to-multipoint",
  ...
  {
    "id": "Q0422",
    "question": "Refer to the exhibit. The New York router is configured with static routes pointing to the Atlanta and\nWashington sites.\nWhich two tasks must be performed so that the Se0/0/0 interfaces on the Atlanta and Washington\nrouters reach one another? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0424",
    "question": "An engineer configured an OSPF neighbor as a designated router. Which state verifies the designated\nrouter is in the proper mode?",
    "options": [
      "Init",
      "2-way",
      "Exchange",
  ...
  {
    "id": "Q0426",
    "question": "Refer to the exhibit. If configuring a static default route on the router with the ip route 0.0.0.0 0.0.0.0\n10.13.0.1 120 command, how does the router respond?",
    "options": [
  ...
  {
    "id": "Q0427",
    "question": "Refer to the graphic. R1 is unable to establish an OSPF neighbor relationship with R3. What are\npossible reasons for this problem? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0428",
    "question": "Refer to the exhibit. Which command configures a floating static route to provide a backup to the\nprimary link?",
    "options": [
  ...
  {
    "id": "Q0429",
    "question": "Refer to the exhibit. An engineer configured the New York router with static routes that point to the and\nWashington sites. Which command must be configured on the Atlanta and Washington routers so that\nboth sites are able to reach the loopback2 interface on the New York router?",
    "options": [
  ...
  {
    "id": "Q0430",
    "question": "What is the effect when loopback interfaces and the configured router ID are absent during the OSPF\nProcess configuration?",
    "options": [
  ...
  {
    "id": "Q0432",
    "question": "Refer to the exhibit. Traffic sourced from the loopback0 interface is trying to connect via ssh to the host\nat 10.0.1.15. What is the next hop to the destination address?",
    "options": [
      "192.168.0.7",
      "192.168.0.4",
      "192.168.0.40",
  ...
  {
    "id": "Q0438",
    "question": "Refer to the exhibit. Which configuration issue is preventing the OSPF neighbor relationship from\nbeing established between the two routers?",
    "options": [
  ...
  {
    "id": "Q0439",
    "question": "Refer to the exhibit. When router R1 is sending traffic to IP address 10.56.192.1, which interface or\nnext hop address does it use to route the packet?",
    "options": [
      "10.56.0.1",
      "0.0.0.0/0",
      "Vlan57",
  ...
  {
    "id": "Q0440",
    "question": "Refer to the exhibit. Load-balanced traffic is coming in from the WAN destined to a host at\n172.16.1.190. Which next-hop is used by the router to forward the request?",
    "options": [
      "192.168.7.4",
      "192.168.7.7",
      "192.168.7.35",
  ...
  {
    "id": "Q0442",
    "question": "Refer to the exhibit. Routers R1 and R3 have the default configuration. The router R2 priority is set to\n99. Which commands on R3 configure it as the DR in the\n10.0.4.0/24 network?",
    "options": [
    ...
    "exhibit": {
      ...
      "labels": [
        ...
        {
          "text": "LAN 10.0.3.0/24 - R2 Prio 99",
          "attachTo": "r3",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0443",
    "question": "Refer to the exhibit. A network engineer must configure R1 so that it sends all packets destined to the\n10.0.0.0/24 network to R3, and all packets destined to PC1 to R2. Which configuration must the\nengineer implement?",
    "options": [
  ...
  {
    "id": "Q0445",
    "question": "Refer to the exhibit. An engineer assumes a configuration task from a peer. Router A must establish an\nOSPF neighbor relationship with neighbor 172.1.1.1. The output displays the status of the adjacency\nafter 2 hours. What is the next step in the configuration process for the routers to establish an\nadjacency?",
    "options": [
  ...
  {
    "id": "Q0446",
    "question": "Refer to the exhibit. Which two configurations must the engineer apply on this network so that R1\nbecomes the DR? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0447",
    "question": "Refer to the exhibit. Which command configures OSPF on the point-to-point link between routers R1\nand R2?",
    "options": [
      "router-id 10.0.0.15",
  ...
  {
    "id": "Q0448",
    "question": "Refer to the exhibit. A network engineer is in the process of establishing IP connectivity between two\nsites. Routers R1 and R2 are partially configured with IP addressing. Both routers have the ability to\naccess devices on their respective LANs. Which command set configures the IP connectivity between\ndevices located on both LANs in each site?",
    "options": [
  ...
  {
    "id": "Q0449",
    "question": "Refer to the exhibit. Which next-hop IP address does Router1 use for packets destined to host\n10.10.13.158?",
    "options": [
      "10.10.10.9",
      "10.10.10.5",
      "10.10.11.2",
  ...
  {
    "id": "Q0450",
    "question": "Refer to the exhibit. Packets received by the router from BGP enter via a serial interface at\n209.165.201.1. Each route is present within the routing table. Which interface is used to forward traffic\nwith a destination IP of 10.1.1.19?",
    "options": [
      "F0/0",
      "F0/1",
      "F0/4",
  ...
  {
    "id": "Q0451",
    "question": "Refer to the exhibit. Which route must be configured on R1 so that OSPF routing is used when OSPF is\nup, but the server is still reachable when OSPF goes down?",
    "options": [
        ...
        "links": [
          {
            "from": "pc1",
            "to": "r1",
            "subnet": "Mgmt 192.168.1.0/24",
            "labelTo": "Gi0/1"
          },
          {
            "from": "r1",
            "to": "r2",
            "subnet": "OSPF 172.16.2.0/24",
            "labelFrom": "Gi0/0"
          }
        ],
        "labels": [
          {
            "text": "Server 10.1.1.0/24",
            "attachTo": "r2",
            "position": "right"
          }
        ]
  ...
  {
    "id": "Q0454",
    "question": "Refer to the exhibit. R5 is the current DR on the network, and R4 is the BDR. Their interfaces are\nflapping, so a network engineer wants the OSPF network to elect a different DR and BDR. Which set\nof configurations must the engineer implement?",
    "options": [
    ...
    "exhibit": [
      {
        ...
        "labels": [
          {
            "text": "172.16.10.0/24 - OSPF Area 0",
            "attachTo": "sw",
            "position": "above"
          },
          {
  ...
  {
    "id": "Q0455",
    "question": "Refer to the exhibit. Web traffic is coming in from the WAN interface. Which route takes precedence\nwhen the router is processing traffic destined for the LAN network at 10.0.10.0/24?",
    "options": [
  ...
  {
    "id": "Q0456",
    "question": "Refer to the exhibit. A packet sourced from 10.10.10.1 is destined for 10.10.8.14. What is the subnet\nmask of the destination route?",
    "options": [
      "255.255.254.0",
      "255.255.255.240",
      "255.255.255.248",
  ...
  {
    "id": "Q0457",
    "question": "Refer to the exhibit. An engineer must configure router R2 so it is elected as the DR on the WAN\nsubnet. Which command sequence must be configured?",
    "options": [
  ...
  {
    "id": "Q0458",
    "question": "An engineer is configuring router R1 with an IPv6 static route for prefix 2019:C15C:0CAF:E001::/64.\nThe next hop must be 2019:C15C:0CAF:E002::1. The route must be reachable via the R1 Gigabit 0/0\ninterface. Which command configures the designated route?",
    "options": [
  ...
  {
    "id": "Q0459",
    "question": "Refer to the exhibit. Which IPv6 configuration is required for R17 to successfully ping the WAN\ninterface on R18?",
    "options": [
  ...
  {
    "id": "Q0460",
    "question": "Refer to the exhibit. A company is configuring a failover plan and must implement the default routes in\nsuch a way that a floating static route will assume traffic forwarding when the primary link goes down.\nWhich primary route configuration must be used?",
    "options": [
  ...
  {
    "id": "Q0461",
    "question": "OSPF must be configured between routers R1 and R2. Which OSPF configuration must be applied to\nrouter R1 to avoid a DR'BDR election?",
    "options": [
  ...
  {
    "id": "Q0462",
    "question": "Refer to the exhibit. An engineer is updating the R1 configuration to connect a new server to the\nmanagement network. The PCs on the management network must be blocked from pinging the default\ngateway of the new server. Which command must be configured on R1 to complete the task?",
    "options": [
    ...
    "exhibit": {
      ...
      "labels": [
        ...
        {
          "text": "Server-Netz 172.16.2.0/24",
          "attachTo": "srv",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0463",
    "question": "Refer to the exhibit. Router R1 currently is configured to use R3 as the primary route to the internet,\nand the route uses the default administrative distance settings. A network engineer must configure R1\nso that it uses R2 as a backup, but only if R3 goes down. Which command must the engineer configure\non R1 so that it correctly uses R2 as a backup route, without changing the administrative distance\nconfiguration on the link to R3?",
    "options": [
  ...
  {
    "id": "Q0464",
    "question": "Refer to the exhibit. Which action must be taken to ensure that router A is elected as the DR for OSPF\narea 0?",
    "options": [
  ...
  {
    "id": "Q0465",
    "question": "Refer to the exhibit. Packets received by the router from BGP enter via a serial interface at\n209.165.201.10. Each route is present within the routing table. Which interface is used to forward\ntraffic with a destination IP of 10.10 10 24?",
    "options": [
      "F0/10",
      "F0/11",
      "F0/12",
  ...
  {
    "id": "Q0467",
    "question": "Refer to the exhibit. Router R1 resides in OSPF Area 0. After updating the R1 configuration to\ninfluence the paths that it will use to direct traffic, an engineer verified that each of the four Gigabit\ninterfaces has the same route to 10 10.0.0/16.\nWhich interface will R1 choose to send traffic to reach the route?",
    "options": [
      "GigabitEthernet0/0",
      "GigabitEthernet0/1",
      "GigabitEthernet0/2",
  ...
  {
    "id": "Q0469",
    "question": "Refer to the exhibit. Which command must be issued to enable a floating static default route on router\nA?",
    "options": [
  ...
  {
    "id": "Q0470",
    "question": "Refer to the exhibit. Which configuration allows routers R14 and R86 to form an OSPFv2 adjacency\nwhile acting as a central point for exchanging OSPF information between routers?",
    "options": [
  ...
  {
    "id": "Q0471",
    "question": "Refer to the exhibit. When an administrator executes the show ip route command on router D to view\nits routing table, which value is displayed for the administrative distance for the route to network\n192.168 1.0?",
    "options": [
      "110",
      "120",
      "170",
    ...
    "exhibit": {
      ...
      "labels": [
        ...
        {
          "text": "Redistribution RIPv2 / OSPF / EIGRP",
          "attachTo": "rb",
          "position": "above"
        }
      ]
  ...
  {
    "id": "Q0472",
    "question": "Refer to the exhibit Routers R1 and R2 have been configured with their respective LAN interfaces. The\ntwo circuits are operational and reachable across WAN.\nWhich command set establishes failover redundancy if the primary circuit goes down?",
    "options": [
      ...
      "links": [
        {
          "from": "r1",
          "to": "r2",
          "subnet": "Primary + Secondary Circuit",
          "labelFrom": ".1 / .5",
          "labelTo": ".2 / .6"
        },
        {
  ...
  {
    "id": "Q0473",
    "question": "Refer to the exhibit. R1 learns all routes via OSPF. Which command configures a backup static route\non R1 to reach the 192.168.20 0/24 network via R3?",
    "options": [
  ...
  {
    "id": "Q0474",
    "question": "Refer to the exhibit. R1 has taken the DROTHER role in the OSPF DR/BDR election process. Which\nconfiguration must an engineer implement so that R1 is elected as the DR?",
    "options": [
    ...
    "exhibit": [
      {
        ...
        "labels": [
          {
            "text": "10.10.10.0/24 - OSPF Area 0",
            "attachTo": "sw",
            "position": "above"
          },
          {
  ...
  {
    "id": "Q0476",
    "question": "An application in the network is being scaled up from 300 servers to 600. Each server requires 3\nnetwork connections to support production, backup, and management traffic. Each connection resides\non a different subnet. The router configuration for the production network must be configured first\nusing a subnet in the 10.0.0.0/8 network. Which command must be configured on the interface of the\nrouter to accommodate the requirements and limit wasted IP address space?",
    "options": [
  ...
  {
    "id": "Q0478",
    "question": "Refer to the exhibit. The administrator must configure a floating static default route that points to\n2001:db8:1234:2::1 and replaces the current default route only if it fails. Which command must the\nengineer configure on the CPE?",
    "options": [
  ...
  {
    "id": "Q0479",
    "question": "Refer to the exhibit. Router OldR is replacing another router on the network with the intention of\nhaving OldR and R2 exchange routes. After the engineer applied the initial OSPF configuration, the\nroutes were still missing on both devices. Which command sequence must be issued before the clear IP\nospf process command is entered to enable the neighbor relationship?",
    "options": [
  ...
  {
    "id": "Q0482",
    "question": "Refer to the exhibit. A static route must be configured on R14 to forward traffic for the 172.21.34.0/25\nnetwork that resides on R86. Which command must be used to fulfill the request?",
    "options": [
    ...
    "exhibit": {
      ...
      "labels": [
        ...
        {
          "text": "Loopback0 10.10.1.86/32 (172.21.34.0/25)",
          "attachTo": "r86",
          "position": "above"
        }
      ]
  ...
  {
    "id": "Q0483",
    "question": "Refer to the exhibit. The network engineer is configuring router R2 as a replacement router on the\nnetwork. After the initial configuration is applied, it is determined that R2 failed to show R1 as a\nneighbor. Which configuration must be applied to R2 to complete the OSPF configuration and enable it\nto establish the neighbor relationship with R1?",
    "options": [
  ...
  {
    "id": "Q0485",
    "question": "A packet from a company's branch office is destined to host 172.31.0.1 at headquarters. The sending\nrouter has three possible matches in its routing table for the packet: prefixes 172.31.0.0/16,\n172.31.0.0/24, and 172.31.0.0/25. How does the router handle the packet?",
    "options": [
  ...
  {
    "id": "Q0486",
    "question": "Refer to the exhibit. An engineer is asked to configure router R1 so that it forms an OSPF single-area\nneighbor relationship with R2. Which command sequence must be implemented to configure the\nrouter?",
    "options": [
  ...
  {
    "id": "Q0487",
    "question": "Refer to the exhibit. All routers in the network are configured. R2 must be the DR. After the engineer\nconnected the devices, R1 was elected as the DR. Which command sequence must be configured on R2\nto be elected as the DR in the network?",
    "options": [
    ...
    "exhibit": {
      ...
      "labels": [
        ...
        {
          "text": "RID 192.168.2.1",
          "attachTo": "r1",
          "position": "above"
        },
        {
          "text": "RID 192.168.2.4",
          "attachTo": "r4",
          "position": "right"
        },
        {
          "text": "RID 192.168.2.8 (DR)",
          "attachTo": "dr",
          "position": "left"
        },
        {
          "text": "RID 192.168.2.8 (BDR)",
          "attachTo": "bdr",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0491",
    "question": "Refer to the exhibit. Traffic from R1 to the 10.10.2.0/24 subnet uses 192.168.1.2 as its next hop. A\nnetwork engineer wants to update the R1 configuration so that traffic with destination 10.10 2.1 passes\nthrough router R3, and all other traffic to the 10.10.2.0/24 subnet passes through R2. Which command\nmust be used?",
    "options": [
  ...
  {
    "id": "Q0492",
    "question": "Refer to the exhibit. The image server and client A are running an application that transfers an\nextremely high volume of data between the two. An engineer is configuring a dedicated circuit between\nR1 and R2. Which set of commands must the engineer apply to the routers so that only traffic between\nthe image server and client A is forces to use the new circuit?",
    "options": [
      "R1(config)#ip route 10.10.13.10 255.255.255.255 10.10.10.6 R2(config)#ip route 192.168.0.100 255.255.255.255 10.10.10.5",
        ...
        "links": [
          {
            "from": "r1",
            "to": "r2",
            "subnet": "10.10.10.0/30 + 10.10.16.0/30",
            "labelFrom": ".1 / .5",
            "labelTo": ".2 / .6"
          },
          {
  ...
  {
    "id": "Q0493",
    "question": "Refer to the exhibit. An engineer is checking the routing table in the main router to identify the path to\na server on the network. Which route does the router use to reach the server at 192.168.2.2?",
    "options": [
  ...
  {
    "id": "Q0496",
    "question": "Refer to the exhibit. After applying this configuration to router R1, a network engineer is verifying the\nimplementation. If all links are operating normally, and the engineer sends a series of packets from PC1\nto PC3, how are the packets routed?",
    "options": [
    ...
    "exhibit": [
      {
        ...
        "links": [
          ...
          },
          {
            "from": "r17",
            "to": "r18",
            "subnet": "2001:db8:3::/64 (S0/0/0 + S0/0/1)",
            "labelFrom": "Fa1/0",
            "labelTo": "Fa1/0"
          },
          {
  ...
  {
    "id": "Q0497",
    "question": "Refer to the exhibit. When router R1 receives a packet with destination IP address 10.56.0.62, through\nwhich interface does it route the packet?",
    "options": [
      "Vlan58",
      "Null0",
      "Vlan59",
  ...
  {
    "id": "Q0498",
    "question": "Refer to the exhibit. How much OSPF be configured on the GigabitEthernet0/0 interface of the\nneighbor device to achieve the destined neighbor relationship?",
    "options": [
  ...
  {
    "id": "Q0499",
    "question": "An engineer just installed network 10.120.10.0/24. Which configuration must be applied to the R14\nrouter to add the new network to its OSPF routing table?",
    "options": [
  ...
  },
  {
    ...
    "options": [
      ...
      "00-00-5E-00-01-0a",
      "00-00-0C-07-AD-89",
      "00-07-C0-70-AB-01 Why would VRRP be implemented when configuring a new subnet in a multivendor environment?",
      "when a gateway protocol is required that supports more than two Cisco devices for redundancy",
      "to interoperate normally with all vendors and provide additional security features for Cisco devices Jonny",
  ...
  {
    "id": "Q0504",
    "question": "Which type of address is shared by routers in a HSRP implementation and used by hosts on the subnet\nas their default gateway address?",
    "options": [
      "multicast address",
      "virtual IP address",
      "loopback IP address",
  ...
  {
    "id": "Q0506",
    "question": "Refer to the exhibit. Router R1 is added to the network and configured with the 10.0.0.64/26 and\n10.0.20.0/26 subnets. However, traffic destined for the LAN on\nR3 is not accessible. Which command when executed on R1 defines a static route to reach the R3\nLAN?",
    "options": [
  ...
  {
    "id": "Q0507",
    "question": "A router has two static routes to the same destination network under the same OSPF process. How does\nthe router forward packets to the destination if the net- hop devices are different?",
    "options": [
  ...
  },
  {
    ...
    "exhibit": {
      "type": "cli",
      "content": "R1(config)#ip nat pool cisco 10.1.1.0 10.1.1.50 255.255.255.0"
    },
  ...
  {
    "id": "Q0513",
    "question": "Refer to the exhibit. After you apply the given configuration to a router, the DHCP clients behind the\ndevice cannot communicate with hosts outside of their subnet.\nWhich action is most likely to correct the problem?",
    "options": [
  ...
  {
    "id": "Q0517",
    "question": "Which command is used to verify the DHCP relay agent address that has been set up on your Cisco\nIOS router?",
    "options": [
  ...
  {
    "id": "Q0522",
    "question": "A network administrator enters the following command on a router: logging trap 3. What are three\nmessage types that will be sent to the Syslog server? (Choose three.)",
    "options": [
      "informational",
      "emergency",
      "warning",
  ...
  {
    "id": "Q0524",
    "question": "A network engineer must back up 20 network router configurations globally within a customer\nenvironment. Which protocol allows the engineer to perform this function using the Cisco IOS MIB?",
    "options": [
      "ARP",
      "SNMP",
      "SMTP",
  ...
  {
    "id": "Q0530",
    "question": "Refer to the exhibit. An engineer deploys a topology in which R1 obtains its IP configuration from\nDHCP. If the switch and DHCP server configurations are complete and correct, which two sets of\ncommands must be configured on R1 and R2 to complete the task? (Choose two.)",
    "options": [
    ...
    "exhibit": {
      ...
      "links": [
        ...
        },
        {
          "from": "sw",
          "to": "r2",
          "labelTo": "gi0/0 192.0.2.2"
        },
        {
          "from": "r2",
          "to": "dhcp",
          "labelFrom": "gi0/1 198.51.100.1",
          "labelTo": ".100"
        }
      ],
      "labels": [
        {
          "text": "DHCP server 198.51.100.100",
          "attachTo": "dhcp",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0532",
    "question": "Refer to the exhibit. An engineer configured NAT translations and has verified that the configuration is\ncorrect. Which IP address is the source IP after the NAT has taken place?",
    "options": [
      "10.4.4.4",
      "10.4.4.5",
      "172.23.103.10",
  ...
  {
    "id": "Q0535",
    "question": "Which two tasks must be performed to configure NTP to a trusted server in client mode on a single\nnetwork device? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0537",
    "question": "An engineer is configuring NAT to translate the source subnet of 10.10.0.0/24 to any one of three\naddresses: 192.168.3.1, 192.168.3.2, or 192.168.3.3. Which configuration should be used?",
    "options": [
  ...
  {
    "id": "Q0539",
    "question": "What protocol allows an engineer to back up 20 network router configurations globally while using the\ncopy function?",
    "options": [
      "TCP",
      "SMTP",
      "FTP",
  ...
  {
    "id": "Q0541",
    "question": "Which two pieces of information can you determine from the output of the show ntp status command?\n(Choose two.)",
    "options": [
  ...
  {
    "id": "Q0542",
    "question": "Which keyword in a NAT configuration enables the use of one outside IP address for multiple inside\nhosts?",
    "options": [
      "source",
      "static",
      "pool",
  ...
  {
    "id": "Q0543",
    "question": "Which feature or protocol determines whether the QOS on the network is sufficient to support IP\nservices?",
    "options": [
      "LLDP",
      "CDP",
      "IP SLA",
  ...
  {
    "id": "Q0554",
    "question": "Which QoS tool is used to optimize voice traffic on a network that is primarily intended for data\ntraffic?",
    "options": [
      "WRED",
      "FIFO",
      "WFQ",
  ...
  {
    "id": "Q0555",
    "question": "An engineer is installing a new wireless printer with a static IP address on the Wi-Fi network. Which\nfeature must be enabled and configured to prevent connection issues with the printer?",
    "options": [
      "client exclusion",
  ...
  {
    "id": "Q0556",
    "question": "When a client and server are not on the same physical network, which device is used to forward\nrequests and replies between client and server for DHCP?",
    "options": [
      "DHCPOFFER",
      "DHCP relay agent",
      "DHCP server",
  ...
  {
    "id": "Q0557",
    "question": "Refer to the exhibit. The ntp server 192.168.0.3 command has been configured on router 1 to make it\nan NTP client of router 2. Which command must be configured on router 2 so that it operates in server-\nonly mode and relies only on its internal clock?",
    "options": [
      ...
      "links": [
        {
          "from": "r1",
          "to": "r2",
          "labelFrom": "192.168.0.2",
          "labelTo": "192.168.0.3"
        }
      ],
      "labels": [
        {
          "text": "Loopback0: 172.17.0.1",
          "attachTo": "r2",
          "position": "above"
        }
      ]
  ...
  {
    "id": "Q0558",
    "question": "Which protocol requires authentication to transfer a backup configuration file from a router to a remote\nserver?",
    "options": [
      "FTP",
      "SMTP",
      "TFTP",
  ...
  {
    "id": "Q0560",
    "question": "An engineer is configuring switch SW1 to act as an NTP server when all upstream NTP server\nconnectivity fails. Which configuration must be used?",
    "options": [
  ...
  {
    "id": "Q0561",
    "question": "A network administrator must enable DHCP services between two sites. What must be configured for\nthe router to pass DHCPDISCOVER messages on to the server?",
    "options": [
      "DHCP Binding",
      "a DHCP Relay Agent",
      "DHCP Snooping",
  ...
  {
    "id": "Q0563",
    "question": "On workstations running Microsoft Windows, which protocol provides the default gateway for the\ndevice?",
    "options": [
      "STP",
      "DHCP",
      "SNMP",
  ...
  {
    "id": "Q0565",
    "question": "Refer to the exhibit. Which configuration must be applied to the router that configures PAT to translate\nall addresses in VLAN 200 while allowing devices on VLAN\n100 to use their own IP addresses?",
    "options": [
    ...
    "exhibit": {
      ...
      "links": [
        ...
        },
        {
          "from": "sw",
          "to": "vlan100",
          "labelTo": "192.168.100.1/27"
        },
        {
          "from": "sw",
          "to": "vlan200",
          "labelTo": "192.168.100.33/27"
        }
      ],
      "labels": [
        {
          "text": "g2/0/1.100 (VLAN 100)",
          "attachTo": "vlan100",
          "position": "below"
        },
        {
          "text": "g2/0/1.200 (VLAN 200)",
          "attachTo": "vlan200",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0566",
    "question": "Refer to the exhibit. Which two commands must be added to update the configuration of router R1 so\nthat it accepts only encrypted connections? (Choose two.)",
    "options": [
      "transport input ssh",
  ...
  {
    "id": "Q0570",
    "question": "A network engineer is configuring a switch so that it is remotely reachable via SSH. The engineer has\nalready configured the host name on the router. Which additional command must the engineer\nconfigure before entering the command to generate the RSA key?",
    "options": [
      "password password",
  ...
  {
    "id": "Q0571",
    "question": "Which QoS traffic handling technique retains excess packets in a queue and reschedules these packets\nfor later transmission when the configured maximum bandwidth has been surpassed?",
    "options": [
      "traffic policing",
  ...
  {
    "id": "Q0573",
    "question": "Refer to the exhibit. The DHCP server and clients are connected to the same switch. What is the next\nstep to complete the DHCP configuration to allow clients on\nVLAN 1 to receive addresses from the DHCP server?",
    "options": [
  ...
  {
    "id": "Q0574",
    "question": "A network analyst is tasked with configuring the date and time on a router using EXEC mode. The date\nmust be set to January 1, 2020 and the time must be set to\n12:00 am. Which command should be used?",
    "options": [
      "clock timezone",
  ...
  {
    "id": "Q0576",
    "question": "Which command creates a static NAT binding for a PC address of 10.1.1.1 to the public routable\naddress 209.165.200.225 assigned to the PC?",
    "options": [
  ...
  {
    "id": "Q0579",
    "question": "Which QoS forwarding per-hop behavior changes a specific value in a packet header to set the class of\nservice for the packet?",
    "options": [
      "shaping",
      "classification",
      "policing",
  ...
  {
    "id": "Q0580",
    "question": "Refer to the exhibit. How should the configuration be updated to allow PC1 and PC2 access to the\nInternet?",
    "options": [
        ...
        "links": [
          {
            "from": "pc1",
            "to": "nat",
            "labelFrom": "172.16.0.1",
            "labelTo": "g0/0"
          },
          {
            "from": "pc2",
            "to": "nat",
            "labelFrom": "172.16.0.2"
          },
          {
            "from": "nat",
            "to": "net",
  ...
  {
    "id": "Q0582",
    "question": "Refer to the exhibit. Which configuration enables DHCP addressing for hosts connected to interface\nFastEthernet0/1 on router R4?",
    "options": [
  ...
  {
    "id": "Q0584",
    "question": "An engineer is configuring SSH version 2 exclusively on the R1 router. What is the minimum\nconfiguration required to permit remote management using the cryptographic protocol?",
    "options": [
  ...
  {
    "id": "Q0585",
    "question": "Which per-hop traffic-control feature does an ISP implement to mitigate the potential negative effects\nof a customer exceeding its committed bandwidth?",
    "options": [
      "policing",
      "queuing",
      "marking",
  ...
  {
    "id": "Q0590",
    "question": "Refer to the exhibit. What is the next step to complete the implementation for the partial NAT\nconfiguration shown?",
    "options": [
  ...
  {
    "id": "Q0593",
    "question": "Refer to the exhibit. A newly configured PC fails to connect to the internet by using TCP port 80 to\nwww.cisco.com. Which setting must be modified for the connection to work?",
    "options": [
      "Subnet Mask",
      "DNS Servers",
      "Default Gateway",
  ...
  {
    "id": "Q0598",
    "question": "Refer to the exhibit. Which plan must be implemented to ensure optimal QoS marking practices on this\nnetwork?",
    "options": [
  ...
  {
    "id": "Q0600",
    "question": "Which QoS tool can you use to optimize voice traffic on a network that is primarily intended for data\ntraffic?",
    "options": [
      "WRED",
      "FIFO",
      "PQ",
  ...
  {
    "id": "Q0601",
    "question": "Refer to the exhibit. Users on existing VLAN 100 can reach sites on the Internet. Which action must\nthe administrator take to establish connectivity to the Internet for users in VLAN 200?",
    "options": [
  ...
  {
    "id": "Q0602",
    "question": "An organization secures its network with multi-factor authentication using an authenticator app on\nemployee smartphones. How is the application secured in the case of a user's smartphone being lost or\nstolen?",
    "options": [
  ...
  {
    "id": "Q0604",
    "question": "A network administrator enabled port security on a switch interface connected to a printer. What is the\nnext configuration action in order to allow the port to learn the MAC address of the printer and insert it\ninto the table automatically?",
    "options": [
  ...
  {
    "id": "Q0605",
    "question": "Refer to the exhibit. An engineer booted a new switch and applied this configuration via the console\nport. Which additional configuration must be applied to allow administrators to authenticate directly to\nenable privilege mode via Telnet using a local username and password?",
    "options": [
  ...
  {
    "id": "Q0607",
    "question": "Refer to the exhibit. Which two events occur on the interface, if packets from an unknown Source\naddress arrive after the interface learns the maximum number of secure MAC address? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0608",
    "question": "Which technology must be implemented to configure network device monitoring with the highest\nsecurity?",
    "options": [
      "IP SLA",
      "syslog",
      "NetFlow",
  ...
  {
    "id": "Q0609",
    "question": "Refer to the exhibit. Which two statements about the interface that generated the output are true?\n(Choose two.)",
    "options": [
  ...
  },
  {
    ...
    "exhibit": {
      "type": "cli",
      "content": "ip arp inspection vlan 2\ninterface fastethernet 0/1\n        switchport mode access\n        switchport access vlan 2"
    },
    "blueprint_section": "5.7",
    "blueprint_domain": "5.0",
    "priority_score": 80,
  ...
  {
    "id": "Q0613",
    "question": "When configuring a WLAN with WPA2 PSK in the Cisco Wireless LAN Controller GUI, which two\nformats are available to select? (Choose two.)",
    "options": [
      "decimal",
      "ASCII",
      "hexadecimal",
  ...
  {
    "id": "Q0615",
    "question": "An engineer is asked to protect unused ports that are configured in the default VLAN on a switch.\nWhich two steps will fulfill the request? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0616",
    "question": "An email user has been lured into clicking a link in an email sent by their company's security\norganization. The webpage that opens reports that it was safe, but the link may have contained\nmalicious code.\nWhich type of security program is in place?",
    "options": [
      "user awareness",
      "brute force attack",
  ...
  {
    "id": "Q0618",
    "question": "Which feature on the Cisco Wireless LAN Controller when enabled restricts management access from\nspecific networks?",
    "options": [
      "TACACS",
      "CPU ACL",
      "Flex ACL",
  ...
  {
    "id": "Q0621",
    "question": "Refer to the exhibit. An extended ACL has been configured and applied to router R2. The configuration\nfailed to work as intended.\nWhich two changes stop outbound traffic on TCP ports 25 and 80 to 10.0.20.0/26 from the 10.0.10.0/26\nsubnet while still allowing all other traffic? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0622",
    "question": "An engineer must configure a WLAN using the strongest encryption type for WPA2-PSK. Which\ncipher fulfills the configuration requirement?",
    "options": [
      "WEP",
      "AES",
      "RC4",
  ...
  {
    "id": "Q0625",
    "question": "While examining excessive traffic on the network, it is noted that all incoming packets on an interface\nappear to be allowed even though an IPv4 ACL is applied to the interface. Which two\nmisconfigurations cause this behavior? (Choose two.)",
    "options": [
      "The ACL is empty",
  ...
  {
    "id": "Q0626",
    "question": "The service password-encryption command is entered on a router. What is the effect of this\nconfiguration?",
    "options": [
  ...
  {
    "id": "Q0628",
    "question": "Refer to the exhibit. If the network environment is operating normally, which type of device must be\nconnected to interface fastethernet 0/1?",
    "options": [
      "DHCP client",
      "access point",
      "router",
    ...
    "exhibit": {
      "type": "cli",
      "content": "ip arp inspection vlan 2-10\ninterface fastethernet 0/1\n        ip arp inspection trust"
    },
    "blueprint_section": "3.1.d",
    "blueprint_domain": "3.0",
    "priority_score": 75,
  ...
  {
    "id": "Q0629",
    "question": "Refer to the exhibit. An administrator configures four switches for local authentication using passwords\nthat are stored as a cryptographic hash. The four switches must also support SSH access for\nadministrators to manage the network infrastructure. Which switch is configured correctly to meet\nthese requirements?",
    "options": [
      "SW1",
      "SW2",
      "SW3",
  ...
  },
  {
    ...
    "exhibit": {
      "type": "cli",
      "content": "ip arp inspection vlan 5-10\ninterface fastethernet 0/1\n    switchport mode access\n    switchport access vlan 5"
    },
    "blueprint_section": "5.7",
    "blueprint_domain": "5.0",
    "priority_score": 80,
  ...
  {
    "id": "Q0634",
    "question": "Which command prevents passwords from being stored in the configuration as plain text on a router or\nswitch?",
    "options": [
      "enable secret",
      "enable password",
      "service password-encryption",
  ...
  {
    "id": "Q0636",
    "question": "In which two ways does a password manager reduce the chance of a hacker stealing a user's password?\n(Choose two.)",
    "options": [
  ...
  {
    "id": "Q0640",
    "question": "What are two recommendations for protecting network ports from being exploited when located in an\noffice space outside of an IT closet? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0641",
    "question": "Refer to the exhibit. A network administrator must permit SSH access to remotely manage routers in a\nnetwork. The operations team resides on the 10.20.1.0/25 network. Which command will accomplish\nthis task?",
    "options": [
  ...
  {
    "id": "Q0642",
    "question": "A port security violation has occurred on a switch port due to the maximum MAC address count being\nexceeded. Which command must be configured to increment the security-violation count and forward\nan SNMP trap?",
    "options": [
  ...
  {
    "id": "Q0645",
    "question": "A network administrator must configure SSH for remote access to router R1. The requirement is to use\na public and private key pair to encrypt management traffic to and from the connecting client. Which\nconfiguration, when applied, meets the requirements?",
    "options": [
  ...
  {
    "id": "Q0646",
    "question": "When a WLAN with WPA2 PSK is configured in the Wireless LAN Controller GUI, which format is\nsupported?",
    "options": [
      "decimal",
      "ASCII",
      "unicode",
  ...
  {
    "id": "Q0647",
    "question": "Refer to the exhibit. A network administrator has been tasked with securing VTY access to a router.\nWhich access-list entry accomplishes this task?",
    "options": [
  ...
  {
    "id": "Q0648",
    "question": "Which two protocols must be disabled to increase security for management connections to a Wireless\nLAN Controller? (Choose two.)",
    "options": [
      "HTTPS",
      "SSH",
      "HTTP",
  ...
  {
    "id": "Q0649",
    "question": "Which security program element involves installing badge readers on data-center doors to allow\nworkers to enter and exit based on their job roles?",
    "options": [
      "physical access control",
      "biometrics",
  ...
  {
    "id": "Q0653",
    "question": "In a Cisco Software Defined Networking (SDN) architecture, what is used to describe the API\ncommunication between the SDN controller and the network elements (routers and switches) that it\nmanages?",
    "options": [
      "Southbound API",
      "Northbound API",
      "Westbound API",
  ...
  {
    "id": "Q0655",
    "question": "A network engineer is asked to configure VLANS 2, 3, and 4 for a new implementation. Some ports\nmust be assigned to the new VLANS with unused ports remaining. Which action should be taken for\nthe unused ports?",
    "options": [
  ...
  {
    "id": "Q0656",
    "question": "When a WPA2-PSK WLAN is configured in the Wireless LAN Controller, what is the minimum\nnumber of characters that is required in ASCII format?",
    "options": [
      "6",
      "8",
      "12",
  ...
  {
    "id": "Q0658",
    "question": "Refer to the exhibit. An access-list is required to permit traffic from any host on interface Gi0/0 and\ndeny traffic from interface Gi0/1. Which access list must be applied?\nQ0659 Nachfragen",
    "options": [
      ...
      "ip access-list standard 199 permit 10.100.100.0 0.0.0.255 deny 192.168.0.0 0.0.255.255 Refer to the exhibit. Which two commands must be configured on router R1 to enable the router to accept secure remote-access connections? (Choose two.)",
      "ip ssh pubkey-chain",
  ...
  {
    "id": "Q0664",
    "question": "Refer to the exhibit. An access list is created to deny Telnet access from host PC-1 to RTR-1 and allow\naccess from all other hosts. A Telnet attempt from PC-2 gives this message: \"% Connection refused by\nremote host.\" Without allowing Telnet access from PC-1, which action must be taken to permit the\ntraffic?\nQ0664 (2)",
    "options": [
  ...
  {
    "id": "Q0668",
    "question": "Refer to the exhibit. Clients on the WLAN are required to use 802.11r. What action must be taken to\nmeet the requirement?",
    "options": [
  ...
  {
    "id": "Q0673",
    "question": "An engineer has configured the domain name, user name, and password on the local router. What is the\nnext step to complete the configuration for a Secure Shell access RSA key?",
    "options": [
  ...
  {
    "id": "Q0674",
    "question": "Which type if network attack overwhelms the target server by sending multiple packets to a port until\nthe half-open TCP resources of the target are exhausted?",
    "options": [
      "SYN flood",
      "reflection",
      "teardrop",
  ...
  {
    "id": "Q0677",
    "question": "After a recent security breach and a RADIUS failure, an engineer must secure the console port of each\nenterprise router with a local username and password.\nWhich configuration must the engineer apply to accomplish this task?",
    "options": [
  ...
  {
    "id": "Q0680",
    "question": "A network engineer is replacing the switches that belong to a managed-services client with new Cisco\nCatalyst switches. The new switches will be configured for updated security standards including\nreplacing.\nTelnet services with encrypted connections and doubling the modulus size from 1024. Which two\ncommands must the engineer configure on the new switches?\n(Choose two.)",
    "options": [
      "transport input ssh",
      "transport input all",
  ...
  {
    "id": "Q0695",
    "question": "When a site-to-site VPN is configured which IPsec mode provides encapsulation and encryption of the\nentire original IP packet?",
    "options": [
  ...
  {
    "id": "Q0696",
    "question": "An engineer is configuring remote access to a router from IP subnet 10.139.58.0/28. The domain name,\ncrypto keys, and SSH have been configured. Which configuration enables the traffic on the destination\nrouter?",
    "options": [
  ...
  {
    "id": "Q0699",
    "question": "Refer to the exhibit. What are the two steps an engineer must take to provide the highest encryption and\nauthentication using domain credentials from LDAP?\n(Choose two.)",
    "options": [
    ...
    "exhibit": {
      ...
      "rows": [
        ...
        [
          "WPA2 Encryption",
          "AES / TKIP — keines aktiviert"
        ],
        [
          "Auth Key Mgmt: 802.1X / CCKM / PSK",
          "keines aktiviert"
        ]
      ]
    },
  ...
  },
  {
    ...
    "options": [
      ...
      "uses TKIP",
      "protects against brute force attacks they mitigate on the right. #DHCPSnooping - Rogue server, #DynamicARPInspection - Cache poisoning, #IPSourceGuard - rogue clients #stormcontrol - flood attacks"
    ],
    "correct": 3,
    "exhibit": false,
    "blueprint_section": "5.9",
  ...
  {
    "id": "Q0702",
    "question": "SW1 supports connectivity for a lobby conference room and must be secured. The engineer must limit\nthe connectivity from PC1 to the SW1 and SW2 network.\nThe MAC addresses allowed must be limited to two. Which configuration secures the conference room\nconnectivity?",
    "options": [
  ...
  {
    "id": "Q0703",
    "question": "Refer to the exhibit. An engineer is updating the management access configuration of switch SW1 to\nallow secured, encrypted remote configuration. Which two commands or command sequences must the\nengineer apply to the switch? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0704",
    "question": "Which port security violation mode allows from valid MAC addresses to pass but blocks traffic from\ninvalid MAC addresses?",
    "options": [
      "restrict",
      "shutdown",
      "protect",
  ...
  {
    "id": "Q0705",
    "question": "A customer wants to provide wireless access to contractors using a guest portal on Cisco ISE. The\nportal is also used by employees. A solution is implemented, but contractors receive a certificate error\nwhen they attempt to access the portal. Employees can access the portal without any errors. Which\nchange must be implemented to allow the contractors and employees to access the portal?",
    "options": [
  ...
  {
    "id": "Q0706",
    "question": "Which two wireless security standards use counter mode cipher block chaining Message Authentication\nCode Protocol for encryption and data integrity? (Choose two.)",
    "options": [
      "Wi-Fi 6",
      "WPA3",
      "WEP",
  ...
  {
    "id": "Q0707",
    "question": "A network engineer is implementing a corporate SSID for WPA3-Personal security with a PSK. Which\nencryption cipher must be configured?",
    "options": [
      "CCMP128",
      "GCMP256",
      "CCMP256",
  ...
  {
    "id": "Q0709",
    "question": "An administrator must use the password complexity not manufacturer-name command to prevent users\nfrom adding `Cisco` as a password. Which command must be issued before this command?",
    "options": [
  ...
  {
    "id": "Q0710",
    "question": "An organization has decided to start using cloud-provided services. Which cloud service allows the\norganization to install its own operating system on a virtual machine?",
    "options": [
  ...
  {
    "id": "Q0711",
    "question": "How do traditional campus device management and Cisco DNA Center device management differ in\nregards to deployment?",
    "options": [
  ...
  {
    "id": "Q0724",
    "question": "Which two capabilities of Cisco DNA Center make it more extensible as compared to traditional\ncampus device management? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0726",
    "question": "What software-defined architecture plane assists network devices with making packet-forwarding\ndecisions by providing Layer 2 reachability and Layer 3 routing information?",
    "options": [
      "management plane",
      "control plane",
      "data plane",
  ...
  {
    "id": "Q0727",
    "question": "What are two benefits of controller-based networking compared to traditional networking? (Choose\ntwo.)",
    "options": [
  ...
  },
  {
    ...
    "exhibit": {
      "type": "cli",
      "content": "cisco_ospf_vrf {\"R1 default\":\n        ensure => 'present',\n        auto_cost => '100',\n}"
    },
    "blueprint_section": "6.6",
    "blueprint_domain": "6.0",
    "priority_score": 65,
    "classifier_confidence": "medium"
  },
  {
    "id": "Q0739",
    "question": "Which configuration management mechanism uses TCP port 22 by default when communicating with\nmanaged nodes?",
    "options": [
      "Ansible",
      "Python",
      "Puppet",
  ...
  {
    "id": "Q0740",
    "question": "What does an SDN controller use as a communication protocol to relay forwarding changes to a\nsouthbound API?",
    "options": [
      "Java",
      "REST",
      "OpenFlow",
  ...
  {
    "id": "Q0743",
    "question": "Which protocol is used in Software Defined Access (SDA) to provide a tunnel between two edge nodes\nin different fabrics?",
    "options": [
  ...
  {
    "id": "Q0745",
    "question": "Where is the interface between the control plane and data plane within the software-defined\narchitecture?",
    "options": [
  ...
  {
    "id": "Q0748",
    "question": "Which two components are needed to create an Ansible script that configures a VLAN on a switch?\n(Choose two.)",
    "options": [
      "playbook",
      "recipe",
      "model",
  ...
  {
    "id": "Q0751",
    "question": "What makes Cisco DNA Center different from traditional network management applications and their\nmanagement of networks?",
    "options": [
  ...
  {
    "id": "Q0756",
    "question": "What differentiates device management enabled by Cisco DNA Center from traditional campus device\nmanagement?",
    "options": [
      "CLI-oriented device",
      "centralized",
  ...
  {
    "id": "Q0765",
    "question": "Which technology is appropriate for communication between an SDN controller end applications\nrunning over the network?",
    "options": [
      "Southbound API",
      "REST API",
      "NETCONF",
  ...
  },
  {
    ...
    "options": [
      ...
      "2",
      "3",
      "4 Which definition describes JWT in regard to REST API security?",
  ...
  },
  {
    ...
    "exhibit": {
      "type": "cli",
      "content": "{\"Employee's name\": \"Arthur\"}"
    },
    "blueprint_section": "6.7",
    "blueprint_domain": "6.0",
    "priority_score": 65,
  ...
  {
    "id": "Q0786",
    "question": "With REST API, which standard HTTP header tells a server which media type is expected by the\nclient?\nQ0787 Nachfragen",
    "options": [
      "Accept-Encoding: gzip. deflate",
      "Accept-Patch: text/example; charset=utf-8",
      "Content-Type: application/json; charset=utf-8",
      "Accept: application/json Refer to the exhibit. How many objects are present in the given JSON-encoded data?",
      "One",
      "Four",
      "Seven",
      "Nine"
  ...
  {
    "id": "Q0790",
    "question": "Refer to the exhibit. A network engineer must configure NETCONF. After creating the configuration,\nthe engineer gets output from the command show line but not from show running-config. Which\ncommand completes the configuration?",
    "options": [
  ...
  {
    "id": "Q0794",
    "question": "Refer to the exhibit. A network engineer must provide configured IP addressing details to investigate a\nfirewall rule issue. Which subnet and mask identify what is configured on the en0 interface?",
    "options": [
      "10.8.0.0/16",
      "10.8.64.0/18",
      "10.8.128.0/19",
  ...
  {
    "id": "Q0796",
    "question": "Which element of a virtualization solution manages virtualized services and enables connections\nbetween virtualized services and external interfaces?",
    "options": [
      "software",
  ...
  {
    "id": "Q0800",
    "question": "Which cable type must be used to interconnect one switch using 1000 BASE-SX GBIC modules and\nanother switch using 1000 BASE-SX SFP modules?",
    "options": [
      "LC to SC",
      "SC to SC",
      "LC to LC",
  ...
  },
  {
    ...
    "options": [
      ...
      "flexibility of design Q803 Why is TCP desired over UDP for applications that require extensive error checking, such as HTTPS?",
      ...
      "UDP operates without acknowledgments, and TCP sends an acknowledgment for every packet received. Q804 Which component controls and distributes physical resources for each virtual machine?",
      "hypervisor",
      "OS",
      "CPU",
      "physical enclosure Q805 What is the role of nonoverlapping channels in a wireless environment?",
  ...
  {
    "id": "Q0806",
    "question": "What are two advantages of implementing a controller-based architecture instead of traditional network\narchitecture? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0824",
    "question": "Which IPv6 address range is suitable for anycast addresses for distributed services such as DHCP or\nDNS?",
    "options": [
      "FF00:1/12",
  ...
  {
    "id": "Q0831",
    "question": "Refer to the exhibit. An administrator received a call from a branch office regarding poor application\nperformance hosted at the headquarters. Ethernet 1 is connected between Router1 and the LAN switch.\nWhat identifies the issue?",
    "options": [
  ...
  {
    "id": "Q0834",
    "question": "Refer to the exhibit. Which configuration enables an EtherChannel to form dynamically between SW1\nand SW2 by using an industry-standard protocol, and to support full IP connectivity between all PCs?",
    "options": [
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "Po1 – Lobby Conference Room Access port",
          "attachTo": "sw1",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0836",
    "question": "Refer to the exhibit. Host A switch interface is configured in VLAN 2. Host D sends a unicast packet\ndestined for the IP address of host A.\nWhat does the switch do when it receives the frame from host D?",
    "options": [
  ...
  {
    "id": "Q0837",
    "question": "Refer to the exhibit. A Cisco engineer creates a new WLAN called lantest. Which two actions must be\nperformed so that only high-speed 2.4-Ghz clients connect? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0839",
    "question": "Which two functions does a WLC perform in the lightweight access-point architecture that an AP\nperforms independently in an autonomous architecture? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0840",
    "question": "Refer to the exhibit. A network engineer is configuring a wireless LAN with Web Passthrough Layer 3\nWeb Policy. Which action must the engineer take to complete the configuration?\nQ0841 Nachfragen",
    "options": [
      "Set the Layer 2 Security to 802.1X.",
      "Enable TKIP and CCMP256 WPA2 Encryption.",
      "Enable the WPA Policy.",
      "Set the Layer 2 Security to None. A network administrator plans an update to the WI-FI networks in multiple branch offices. Each location is configured with an SSID called “Office”. The administrator wants every user who connects to the SSID at any location to have the same access level. What must be set the same on each network to meet the requirement?",
      "radio policy",
      "profile name",
  ...
  {
    "id": "Q0842",
    "question": "Refer to the exhibit. The P2P Blocking Action option is disabled on the WLC. The security team has a\nnew requirement for each client to retain their assigned IP addressing as the clients move between\nlocations in the campus network. Which action completes this configuration?",
    "options": [
  ...
  {
    "id": "Q0843",
    "question": "Refer to the exhibit. A multivendor network exists and the company is implementing VoIP over the\nnetwork for the first time. Which configuration is needed to implement the neighbor discovery protocol\non the interface and allow it to remain off for the remaining interfaces?",
    "options": [
  ...
  {
    "id": "Q0844",
    "question": "Refer to the exhibit. Routers R1, R2, and R3 use a protocol to identify the neighbors’ IP addresses,\nhardware platforms, and software versions. A network engineer must configure R2 to avoid sharing any\nneighbor information with R3, and maintain its relationship with R1. What action meets this\nrequirement?",
    "options": [
  ...
  {
    "id": "Q0845",
    "question": "SIP-based Call Admission Control must be configured in the Cisco WLC GUI. SIP call-snooping ports\nare configured. Which two actions must be completed next? (Choose two.)\nQ0846 Nachfragen",
    "options": [
  ...
  {
    "id": "Q0848",
    "question": "Which port state processes BPDUs, but does not forward packets or update the address database in\nRapid PVST+?",
    "options": [
      "blocking",
      "learning",
      "listening",
  ...
  {
    "id": "Q0850",
    "question": "Refer to the exhibit. Rapid PVST+ mode is on the same VLAN on each switch. Which switch becomes\nthe root bridge and why?",
    "options": [
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "Bridge Priority 8192, MAC 00:24:98:6f:3b:40",
          "attachTo": "sw4",
          "position": "below"
        },
        {
          "text": "Bridge Priority 32768, MAC 00:24:98:6f:3b:42",
          "attachTo": "sw3",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0857",
    "question": "When a switch receives a frame from an unknown source MAC address, which action does the switch\ntake with the frame?",
    "options": [
  ...
  {
    "id": "Q0858",
    "question": "When the LAG configuration is updated on a Cisco WLC, which additional task must be performed\nwhen changes are complete?",
    "options": [
      "Reboot the WLC.",
  ...
  {
    "id": "Q0859",
    "question": "Refer to the exhibit. An engineer ts building a new Layer 2 LACP EtherChannel between SW1 and\nSW2, and they executed the given show commands to verify the work. Which additional task must be\nperformed so that the switches successfully bundle the second member in the LACP port-channel?",
    "options": [
  ...
  {
    "id": "Q0860",
    "question": "Refer to the exhibit. VLAN 23 is being implemented between SW1 and SW2. The command show\ninterface ethernet0/0 switchport has been issued on SW1. Ethernet0/0 on SW1 is the uplink to SW2.\nWhich command when entered on the uplink interface allows PC 1 and PC 2 to communicate without\nimpact to the communication between PC 11 and PC 12?",
    "options": [
    ...
    "exhibit": [
      {
        ...
        "labels": [
          {
            "text": "VLAN 23 – New Users / VLAN 22 – Current Users",
            "attachTo": "sw1",
            "position": "below"
          }
        ]
  ...
  {
    "id": "Q0861",
    "question": "A network engineer starts to implement a new wireless LAN by configuring the authentication server\nand creating the dynamic interface. What must be performed next to complete the basic configuration?",
    "options": [
  ...
  {
    "id": "Q0862",
    "question": "Refer to the exhibit. An architect is managing a wireless network with APs from several branch offices\nconnecting to the WLC in the data center. There is a new requirement for a single WLAN to process the\nclient data traffic without sending it to the WLC. Which action must be taken to complete the request?",
    "options": [
    ...
    "exhibit": {
      ...
      "rows": [
        ...
        [
          "Local Client Profiling (DHCP/HTTP)",
          "deaktiviert"
        ],
        [
          "PMIP Mobility Type",
        ...
        [
          "Optimized Roaming Disassociation Timer",
          "40"
        ]
      ]
    },
  ...
  {
    "id": "Q0863",
    "question": "What must be considered for a locally switched FlexConnect AP if the VLANs that are used by the AP\nand client access are different?",
    "options": [
  ...
  {
    "id": "Q0864",
    "question": "Which command configures the Cisco WLC to prevent a serial session with the WLC CLI from being\nautomatically logged out?",
    "options": [
  ...
  {
    "id": "Q0865",
    "question": "A Cisco engineer at a new branch office is configuring a wireless network with access points that\nconnect to a controller that is based at corporate headquarters. Wireless client traffic must terminate at\nthe branch office and access-point survivability is required in the event of a WAN outage. Which access\npoint mode must be selected?",
    "options": [
  ...
  {
    "id": "Q0866",
    "question": "What is an advantage of using auto mode versus static mode for power allocation when an access point\nis connected to a PoE switch port?",
    "options": [
  ...
  {
    "id": "Q0867",
    "question": "Refer to the exhibit. Wireless LAN access must be set up to force all clients from the NA WLAN to\nauthenticate against the local database. The WLAN is configured for local EAP authentication. The\ntime that users access the network must not be limited. Which action completes this configuration?",
    "options": [
  ...
  {
    "id": "Q0872",
    "question": "Refer to the exhibit. A Cisco WLC administrator is creating a new wireless network with enhanced\nSSID security. The new network must operate at 2.4 Ghz with 54 Mbps of throughput. Which set of\ntasks must the administrator perform to complete the configuration?",
    "options": [
  ...
  {
    "id": "Q0873",
    "question": "Which switching feature removes unused MAC addresses from the MAC address table, which allows\nnew MAC addresses to be added?",
    "options": [
      "MAC address aging",
      "MAC move",
  ...
  {
    "id": "Q0874",
    "question": "Refer to the exhibit. A network engineer configures the CCNA WLAN so that clients must\nreauthenticate hourly and to limit the number of simultaneous connections to the WLAN to 10. Which\ntwo actions complete this configuration? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0876",
    "question": "Refer to the exhibit. How must router A be configured so that it only sends Cisco Discovery Protocol\ninformation to router C?",
    "options": [
  ...
  {
    "id": "Q0877",
    "question": "Refer to the exhibit. An administrator must turn off the Cisco Discovery Protocol on the port\nconfigured with address last usable address in the 10.0.0.0/30 subnet. Which command set meets the\nrequirement?",
    "options": [
      ...
      "links": [
        {
          "from": "isp",
          "to": "wan",
          "labelFrom": "Gi0/1 10.0.0.254/30"
        },
        {
          "from": "wan",
          "to": "r1",
          "labelTo": "Gi0/0 10.0.0.253/30"
        }
      ]
    },
    "blueprint_section": "2.3",
  ...
  {
    "id": "Q0879",
    "question": "Which default condition must be considered when an encrypted mobility tunnel is used between two\nCisco WLCs?",
    "options": [
  ...
  {
    "id": "Q0880",
    "question": "Refer to the exhibit. After a recent internal security audit, the network administrator decided to block\nall P2P-capable devices from the selected SSID. Which configuration setting must the administrator\napply?",
    "options": [
  ...
  {
    "id": "Q0882",
    "question": "Which port type does a lightweight AP use to connect to the wired network when it is configured in\nlocal mode?",
    "options": [
      "EtherChannel",
      "access",
      "LAG",
  ...
  {
    "id": "Q0883",
    "question": "Which step immediately follows receipt of the EAP success message when session resumption is\ndisabled for an EAP-TLS connection?",
    "options": [
      "PMKID caching",
      "four-way handshake",
      "802.1X authentication",
  ...
  {
    "id": "Q0884",
    "question": "Refer to the exhibit. All interfaces are in the same VLAN. All switches are configured with the default\nSTP priorities. During the STP elections, which switch becomes the root bridge?",
    "options": [
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "08:E0:43:42:70:13",
          "attachTo": "dc1",
          "position": "below"
        },
        {
          "text": "08:0E:18:22:05:97",
          "attachTo": "dc2",
          "position": "below"
        },
        {
          "text": "08:0E:18:1A:3C:9D",
          "attachTo": "dc3",
          "position": "below"
        },
        {
          "text": "08:E0:19:A1:B3:19",
          "attachTo": "dc4",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0890",
    "question": "A network engineer is upgrading a small data center to host several new applications, including server\nbackups that are expected to account for up to 90% of the bandwidth during peak times. The data\ncenter connects to the MPLS network provider via a primary circuit and a secondary circuit. How does\nthe engineer inexpensively update the data center to avoid saturation of the primary circuit by traffic\nassociated with the backups?",
    "options": [
  ...
  {
    "id": "Q0891",
    "question": "Refer to the exhibit. A network engineer started to configure two directly-connected routers as shown.\nWhich command sequence must the engineer configure on R2 so that the two routers become OSPF\nneighbors?",
    "options": [
  ...
  {
    "id": "Q0893",
    "question": "Refer to the exhibit. Router R14 is in the process of being configured. Which configuration must be\nused to establish a host route to a PC 10?",
    "options": [
  ...
  {
    "id": "Q0895",
    "question": "Refer to the exhibit. The New York router must be configured so that traffic to 2000::1 is sent primarily\nvia the Atlanta site, with a secondary path via Washington that has an administrative distance of 2.\nWhich two commands must be configured on the New York router? (Choose two.)",
    "options": [
      "ipv6 route 2000::1/128 2012::1",
      "ipv6 route 2000::1/128 2012::1 5",
      "ipv6 route 2000::1/128 2012::2",
  ...
  {
    "id": "Q0896",
    "question": "Refer to the exhibit. The primary route across Gi0/0 is configured on both routers. A secondary route\nmust be configured to establish connectivity between the workstation networks. Which command set\nmust be configured to complete this task?",
    "options": [
    ...
    "exhibit": {
      ...
      "devices": [
        ...
        },
        {
          "id": "ws1",
          "type": "pc",
          "label": "Workstations 172.16.1.0/24",
          "x": 200,
          "y": 460
        },
        {
          "id": "ws2",
          "type": "pc",
          "label": "Workstations 172.16.2.0/27",
          "x": 700,
          "y": 460
        }
      ],
      ...
      "labels": [
        {
          "text": "Router OSPF 200: Network 172.16.0.0 0.0.0.3, Network 172.16.1.0 0.0.0.3",
          "attachTo": "r1",
          "position": "below"
        },
        {
          "text": "Router OSPF 200: Network 172.16.0.0 0.0.0.3, Network 172.16.2.0 0.0.0.31",
          "attachTo": "r2",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0898",
    "question": "Refer to the exhibit. Which two values does router R1 use to determine the best path to reach\ndestinations in network 1.0.0.0/8? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0899",
    "question": "Refer to the exhibit. A public IPv6 address must be configured for internet access. Which command\nmust be configured on the R2 WAN interface to the service provider?",
    "options": [
    ...
    "exhibit": {
      ...
      "devices": [
        ...
        },
        {
          "id": "nms",
          "type": "pc",
          "label": "Network Management Server",
          "x": 300,
          "y": 450
        },
        {
      ...
      "labels": [
        {
          "text": "2001:DB8:D8D2:1008::/64",
          "attachTo": "sw1",
          "position": "below"
        },
        {
          "text": "2001:DB8:D8D2:1009::/64",
          "attachTo": "sw2",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0901",
    "question": "Refer to the exhibit. A network engineer must configure router R1 with a host route to the server.\nWhich command must the engineer configure?",
    "options": [
      ...
      "links": [
        {
          "from": "r1",
          "to": "r2",
          "labelFrom": "S0/0 192.168.0.1/30",
          "labelTo": "S0/0 192.168.0.2/30"
        },
        {
          "from": "r2",
          "to": "sw1",
          "labelFrom": "Gi0/0 10.10.10.1/24"
        },
        {
          "from": "sw1",
          "to": "server"
  ...
  {
    "id": "Q0902",
    "question": "Refer to the exhibit. IPv6 is being implemented within the enterprise. The command ipv6 unicast-\nrouting is configured. Interface Gig0/0 on R1 must be configured to provide a dynamic assignment\nusing the assigned IPv6 block. Which command accomplishes this task?",
    "options": [
      ...
      "links": [
        {
          "from": "r1",
          "to": "r2",
          "labelFrom": "GigabitEthernet0/0/0",
          "labelTo": "GigabitEthernet0/0/0"
        }
      ]
    },
    "blueprint_section": "1.6",
  ...
  {
    "id": "Q0906",
    "question": "Refer to the exhibit. A static route must be configured on R86 to forward traffic for the 172.16.34.0/29\nnetwork, which resides on R14. Which command must be used to fulfill the request?",
    "options": [
  ...
  {
    "id": "Q0907",
    "question": "Refer to the exhibit. An engineer must configure a floating static route on an external EIGRP network.\nThe destination subnet is the /29 on the LAN interface of R86. Which command must be executed on\nR14?",
    "options": [
  ...
  {
    "id": "Q0910",
    "question": "Refer to the exhibit. An IPv6 address must be obtained automatically on the LAN interface on R1.\nWhich command must be implemented to accomplish the task?",
    "options": [
  ...
  {
    "id": "Q0911",
    "question": "Refer to the exhibit. A network engineer is updating the configuration on router R1 to connect a new\nbranch office to the company network. R2 has been configured correctly. Which command must the\nengineer configure so that devices at the new site communicate with the main office?",
    "options": [
    ...
    "exhibit": {
      ...
      "labels": [
        ...
        {
          "text": "New Office 172.25.25.0/24",
          "attachTo": "pc2",
          "position": "above"
        }
      ]
  ...
  {
    "id": "Q0912",
    "question": "A network engineer must migrate a router loopback interface to the IPv6 address space. If the current\nIPv4 address of the interface is 10.54.73.1/32, and the engineer configures IPv6 address\n0:0:0:0:0:ffff:a36:4901, which prefix length must be used?",
    "options": [
      "/64",
      "/96",
      "/124",
  ...
  {
    "id": "Q0913",
    "question": "A Cisco engineer notices that two OSPF neighbors are connected using a crossover Ethernet cable. The\nneighbors are taking too long to become fully adjacent. Which command must be issued under the\ninterface configuration on each router to reduce the time required for the adjacency to reach the FULL\nstate?",
    "options": [
  ...
  {
    "id": "Q0914",
    "question": "Refer to the exhibit. PC A is communicating with another device at IP address 10.227.225.255.\nThrough which router does router Y route the traffic?",
    "options": [
      "router A",
      "router B",
      "router C",
        ...
        "links": [
          {
            "from": "pca",
            "to": "ry",
            "labelTo": "G0/1 10.223.2.1"
          },
          {
            "from": "ry",
            "to": "ra",
            "labelFrom": "G0/0 10.224.1.1"
          },
          {
            "from": "ry",
            "to": "rb"
  ...
  {
    "id": "Q0915",
    "question": "Refer to the exhibit. A packet sourced from 10.10.10.32 is destined for the Internet. What is the\nadministrative distance for the destination route?",
    "options": [
      "0",
      "1",
      "2",
  ...
  {
    "id": "Q0916",
    "question": "Refer to the exhibit. Which format matches the Modified EUI-64 IPv6 interface address for the\nnetwork 2001:db8::/64?",
    "options": [
  ...
  {
    "id": "Q0919",
    "question": "Refer to the exhibit. A network engineer executes the show ip route command on router D. What is the\nnext hop to network 192.168.1.0/24 and why?",
    "options": [
    ...
    "exhibit": {
      ...
      "links": [
        ...
        },
        {
          "from": "ra",
          "to": "rb",
          "subnet": "EIGRP100 Metric 128256"
        },
        {
          "from": "rb",
          "to": "rc",
          "subnet": "OSPF AREA 1 Metric 10000 (10.0.1.0/30)"
        },
        {
          "from": "rb",
          "to": "rd",
          "subnet": "EIGRP100 Metric 128256 (10.0.0.0/30)"
        },
        {
          "from": "rc",
          "to": "rd",
          "subnet": "OSPF AREA 1 Metric 10000 (10.0.2.0/30)"
        }
      ],
      "labels": [
        {
          "text": "Redistribution between EIGRP and OSPF",
          "attachTo": "rb",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q0922",
    "question": "Refer to the exhibit. A packet that is sourced from 172.16.3.254 is destined for the IP address of\nGigabitEthernet0/0/0. What is the subnet mask of the destination route?",
    "options": [
      "0.0.0.0",
      "255.255.254.0",
      "255.255.255.0",
  ...
  {
    "id": "Q0923",
    "question": "Refer to the exhibit. The iPv6 address for the LAN segment on router R2 must be configured using the\nEUI-64 format. Which address must be used?",
    "options": [
      ...
      "devices": [
        {
          "id": "r1",
          "type": "router",
          "label": "R1 (MAC 12-a0-ab-dd-00-02)",
          "x": 190,
          "y": 100
        },
        {
          "id": "r2",
          "type": "router",
          "label": "R2 (MAC 12-a0-ab-cc-00-01)",
          "x": 620,
          "y": 100
        },
        {
        ...
        },
        {
          "id": "nms",
          "type": "pc",
          "label": "Network Management Server .4",
          "x": 300,
          "y": 450
        },
        {
      ...
      "links": [
        {
          "from": "r1",
          "to": "r2",
          "labelFrom": "Int G0/0 2001:DB8:44:90::1/64",
          "labelTo": "Int G0/0 2001:DB8:44:90::2/64"
        },
        {
          "from": "r1",
          "to": "sw1"
  ...
  {
    "id": "Q0924",
    "question": "Refer to the exhibit. According to the output, which parameter set is validated using the routing table of\nR7?",
    "options": [
  ...
  {
    "id": "Q0929",
    "question": "Refer to the exhibit. Routers R1 and R2 are configured with RIP as the dynamic routing protocol. A\nnetwork engineer must configure R1 with a floating static route to service as a backup route to network\n192.168.23.0 which command must the engineer configure on R1?",
    "options": [
  ...
  {
    "id": "Q0930",
    "question": "When deploying a new network that includes both Cisco and third-party network devices, which\nredundancy protocol avoids the interruption of network traffic if the default gateway router fails?",
    "options": [
      "VRRP",
      "FHRP",
      "GLBP",
  ...
  {
    "id": "Q0932",
    "question": "Which Cisco proprietary protocol ensures traffic recovers immediately, transparently, and automatically\nwhen edge devices or access circuits fail?",
    "options": [
      "FHRP",
      "VRRP",
      "HSRP",
  ...
  {
    "id": "Q0935",
    "question": "Which two IPv6 addresses are used to provide connectivity between two routers on a shared link?\n(Choose two.)",
    "options": [
  ...
  {
    "id": "Q0937",
    "question": "Refer to the exhibit. Which action is taken by the router when a packet is sourced from 10.10.10.2 and\ndestined for 10.10.10.16?",
    "options": [
  ...
  {
    "id": "Q0939",
    "question": "An engineer must configure a core router with a floating static default route to the backup router at\n10.200.0.2. Which command meets the requirements?",
    "options": [
  ...
  {
    "id": "Q0940",
    "question": "Refer to the exhibit. After configuring a new static route on the CPE, the engineer entered this series of\ncommands to verify that the new configuration is operating normally. When is the static default route\ninstalled into the routing table?",
    "options": [
  ...
  {
    "id": "Q0941",
    "question": "Refer to the exhibit. Packets are flowing from 192.168.10.1 to the destination at IP address\n192.168.20.75. Which next hop will the router select for the packet?",
    "options": [
      "10.10.10.1",
      "10.10.10.11",
      "10.10.10.12",
  ...
  {
    "id": "Q0942",
    "question": "A router received three destination prefixes: 10.0.0.0/8, 10.0.0.0/16, and 10.0.0.0/24. When the show ip\nroute command is executed, which output does it return?",
    "options": [
  ...
  {
    "id": "Q0943",
    "question": "Refer to the exhibit. User traffic originating within site B is failing to reach an application hosted on IP\naddress 192.168.0.10, which is located within site A. What is determined by the routing table?",
    "options": [
  ...
  {
    "id": "Q0944",
    "question": "Refer to the exhibit. Which two values does router R1 use to identify valid routes for the R3 loopback\naddress 1.1.1.3/32? (Choose two.)",
    "options": [
      "lowest cost to reach the next hop",
      "highest administrative distance",
      "lowest metric",
  ...
  {
    "id": "Q0946",
    "question": "Which syslog severity level is considered the most severe and results in the system being considered\nunusable?",
    "options": [
      "Error",
      "Emergency",
      "Alert",
  ...
  {
    "id": "Q0947",
    "question": "The clients and DHCP server reside on different subnets. Which command must be used to forward\nrequests and replies between clients on the 10.10.0.1/24 subnet and the DHCP server at 192.168.10.1?",
    "options": [
  ...
  {
    "id": "Q0948",
    "question": "Refer to the exhibit. Which command set configures ROUTER-1 to allow Internet access for users on\nthe 192.168.1.0/24 subnet while using 209.165.202.129 for Port Address Translation?",
    "options": [
  ...
  {
    "id": "Q0953",
    "question": "A DHCP pool has been created with the name CONTROL. The pool uses the next to last usable IP\naddress as the default gateway for the DHCP clients. The server is located at 172.16.32.15. What is the\nnext step in the process for clients on the 192.168.52.0/24 subnet to reach the DHCP server?",
    "options": [
  ...
  {
    "id": "Q0959",
    "question": "Which two features introduced in SNMPv2 provide the ability to retrieve large amounts of data in one\nrequest and acknowledge a trap using PDUs? (Choose two.)",
    "options": [
      "Get",
      "GetNext",
      "Set",
  ...
  {
    "id": "Q0962",
    "question": "Refer to the exhibit. The DHCP server is configured with a DHCP pool for each of the subnets\nrepresented. Which command must be configured on switch SW1 to allow DHCP clients on VLAN 10\nto receive dynamic IP addresses from the DHCP server?",
    "options": [
        ...
        "devices": [
          {
            "id": "r1",
            "type": "router",
            "label": "R1 (DHCP Server) 192.168.20.2",
            "x": 100,
            "y": 260
          },
          {
  ...
  {
    "id": "Q0964",
    "question": "Refer to the exhibit. Which minimum configuration items are needed to enable Secure Shell version 2\naccess to R15?",
    "options": [
  ...
  {
    "id": "Q0965",
    "question": "hostname CPE\nservice password-encryption\nip domain name ccna.cisco.com\nip name-server 198.51.100.210\ncrypto key generate rsa modulus 1024\nusername admin privilege 15 secret s0m3s3cr3t\nline vty 0 4\ntransport input ssh\nlogin local\nRefer to the exhibit. An engineer executed the script and added commands that were not necessary for\nSSH and now must remove the commands. Which two commands must be executed to correct the\nconfiguration? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q0969",
    "question": "An engineering team asks an implementer to configure syslog for warning conditions and error\nconditions. Which command does the implementer configure to achieve the desired result?",
    "options": [
      "logging trap 5",
      "logging trap 2",
      "logging trap 3",
  ...
  {
    "id": "Q0972",
    "question": "Refer to the exhibit. An engineer booted a new switch and applied this configuration via the console\nport. Which additional configuration must be applied to allow administrators to authenticate directly to\nglobal configuration mode via Telnet using a local username and password?",
    "options": [
  ...
  {
    "id": "Q0974",
    "question": "Refer to the exhibit. A network administrator must permit traffic from the 10.10.0.0/24 subnet to the\nWAN on interface Serial0. What is the effect of the configuration as the administrator applies the\ncommand?",
    "options": [
    ...
    "exhibit": {
      "type": "cli",
      "content": "access-list 10 permit 10.0.0.0 0.0.0.255\n\ninterface Serial0\n\nip access-list 10 in"
    },
    "blueprint_section": "5.6",
    "blueprint_domain": "5.0",
    "priority_score": 65,
  ...
  {
    "id": "Q0976",
    "question": "A network engineer must configure an access list on a new Cisco IOS router. The access list must deny\nHTTP traffic to network 10.125.128.32/27 from the 192.168.240.0/20 network, but it must allow the\n192.168.240.0/20 network to reach the rest of the 10.0.0.0/8 network. Which configuration must the\nengineer apply?",
    "options": [
  ...
  {
    "id": "Q0982",
    "question": "Which type of security program is violated when a group of employees enters a building using the ID\nbadge of only one person?",
    "options": [
      "intrusion detection",
      ...
      "links": [
        {
          "from": "r6",
          "to": "wan",
          "subnet": "10.10.198.0/30"
        },
        {
          "from": "wan",
          "to": "r4",
          "subnet": "10.111.87.0/30"
        },
        {
          "from": "wan",
          "to": "r5",
          "subnet": "10.128.1.0/30"
        }
      ]
    },
    "blueprint_section": "5.3",
  ...
  {
    "id": "Q0991",
    "question": "Which two VPN technologies are recommended by Cisco for multiple branch offices and large-scale\ndeployments? (Choose two.)",
    "options": [
      "GETVPN",
      "DMVPN",
      "site-to-site VPN",
  ...
  {
    "id": "Q0997",
    "question": "Refer to the exhibit. This ACL is configured to allow client access only to HTTP, HTTPS, and DNS\nservices via UDP. The new administrator wants to add TCP access to the ONS service. Which\nconfiguration updates the ACL efficiently?",
    "options": [
  ...
  {
    "id": "Q1000",
    "question": "To improve corporate security, an organization is planning to implement badge authentication to limit\naccess to the data center. Which element of a security program is being deployed?\nQ1001 Nachfragen",
    "options": [
      "user awareness",
      "user training",
      "physical access control",
      "vulnerability verification all characteristics are used. #supportsautomation #communicatesbetweenthesdn #supportsdata #supportsnetwork #supportsrest #usesopen #1 #2 #3 #4"
    ],
    "correct": 2,
    "exhibit": false,
    "blueprint_section": "5.2",
  ...
  {
    "id": "Q1006",
    "question": "Which advantage does the network assurance capability of Cisco DNA Center provide over traditional\ncampus management?",
    "options": [
  ...
  {
    "id": "Q1010",
    "question": "Which function generally performed by a traditional network device is replaced by a software-defined\ncontroller?",
    "options": [
  ...
  },
  {
    ...
    "options": [
      ...
      "offloads the creation of virtual machines to the data plane • Q1015 Refer to the exhibit. What is missing from this output for it to be executed?",
  ...
  {
    "id": "Q1023",
    "question": "A network architect is considering whether to implement Cisco DNA Center to deploy devices on a\nnew network. The organization is focused on reducing the time it currently takes to deploy devices in a\ntraditional campus design. For which reason would Cisco DNA Center be more appropriate than\ntraditional management options?",
    "options": [
  ...
  {
    "id": "Q1026",
    "question": "Which interface enables communication between a program on the controller and a program on the\nnetworking device?",
    "options": [
  ...
  {
    "id": "Q1029",
    "question": "Which interface type enables an application running on a client to send data over an IP network to a\nserver?",
    "options": [
      "northbound interface",
  ...
  {
    "id": "Q1030",
    "question": "Refer to the exhibit. The IPv6 address for the LAN segment on router R2 must be configured using the\nEUI-64 format. When configured which ipv6 address is produced by the router?",
    "options": [
    ...
    "exhibit": {
      ...
      "devices": [
        ...
        },
        {
          "id": "sw1",
          "type": "switch",
          "label": "SW1 (MAC ca-01-6a-4a-00-01)",
          "x": 190,
          "y": 420
        },
        {
          "id": "sw2",
          "type": "switch",
          "label": "SW2 (MAC ca-01-a6-a4-00-01)",
          "x": 810,
          "y": 420
        },
        {
      ...
      "labels": [
        {
          "text": "2001:db8:9aa6:916a::/64",
          "attachTo": "sw1",
          "position": "below"
        },
        {
          "text": "2001:db8:9aa6:6aa9::/64",
          "attachTo": "sw2",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q1033",
    "question": "Refer to the exhibit. A Cisco engineer is asked to update the configuration on switch 1 so that the\nEtherChannel stays up when one of the links fails. Which configuration meets this requirement?",
    "options": [
  ...
  {
    "id": "Q1036",
    "question": "Two switches have been implemented and all interfaces are at the default configuration level. A trunk\nlink must be implemented between two switches with these requirements:\n• using an industry-standard trunking protocol\n• permitting VLANs 1-10 and denying other VLANs\nHow must the interconnecting ports be configured?",
    "options": [
  ...
  {
    "id": "Q1037",
    "question": "Refer to the exhibit. Traffic that is flowing over interface TenGigabitEthemet0/0/0 experiences slow\ntransfer speeds. What is the cause of this issue?",
    "options": [
      "speed conflict",
      "queuing drops",
  ...
  {
    "id": "Q1042",
    "question": "A network administrator wants the syslog server to filter incoming messages into different files based\non their importance. Which filtering criteria must be used?",
    "options": [
      "message body",
      "level",
      "facility",
  ...
  {
    "id": "Q1044",
    "question": "Which interface or port on the WLC is the default for in-band device administration and\ncommunications between the controller and access points?",
    "options": [
      "console port",
  ...
  {
    "id": "Q1046",
    "question": "Refer to the exhibit. A network engineer updates the existing configuration on interface fastethernet1/1\nswitch SW1. It must establish an EtherChannel by using the same group designation with another\nvendor switch. Which configuration must be performed to complete the process?",
    "options": [
  ...
  {
    "id": "Q1050",
    "question": "Refer to the exhibit. An engineer configures interface fa0/1 on SW1 and SW2 to pass traffic from two\ndifferent VLANs. For security reasons, company policy requires the native VLAN to be set to a\nnondefault value. Which configuration meets this requirement?",
    "options": [
  ...
  {
    "id": "Q1053",
    "question": "Refer to the exhibit. A network engineer is adding another physical interface as a new member to the\nexisting Port-Channel1 bundle. Which command set must be configured on the new interface to\ncomplete the process?",
    "options": [
  ...
  {
    "id": "Q1056",
    "question": "Refer to the exhibit SW_1 and SW_12 represent two companies that are merging. They use separate\nnetwork vendors. The VLANs on both sides have been migrated to share IP subnets. Which command\nsequence must be issued on both sides to join the two companies and pass all VLANs between the\ncompanies?",
    "options": [
  ...
  {
    "id": "Q1057",
    "question": "An engineer is configuring a switch port that is connected to a VoIP handset. Which command must the\nengineer configure to enable port security with a manually assigned MAC address of abcd.abcd.abcd\non voice VLAN 4?",
    "options": [
  ...
  {
    "id": "Q1067",
    "question": "What provides connection redundancy, increased bandwidth, and load sharing between a wireless LAN\ncontroller and a Layer 2 switch?",
    "options": [
  ...
  {
    "id": "Q1074",
    "question": "Refer to the exhibit. A network engineer is verifying the settings on a new OSPF network. All OSPF\nconfigurations use the default values unless otherwise indicated. Which router does the engineer expect\nwill be elected as the DR when all devices boot up simultaneously?",
    "options": [
      "R1",
      "R2",
      "R3",
    ...
    "exhibit": {
      ...
      "devices": [
        ...
        },
        {
          "id": "r1",
          "type": "router",
          "label": "R1 DR (192.168.2.8, Prio 108, RID 1.1.1.1)",
          "x": 100,
          "y": 260
        },
        {
          "id": "r4",
          "type": "router",
          "label": "R4 (192.168.2.4, Prio 204, RID 4.4.4.4)",
          "x": 740,
          "y": 260
        },
        {
  ...
  {
    "id": "Q1075",
    "question": "Which command must be entered so that the default gateway is automatically distributed when DHCP\nis configured on a router?",
    "options": [
      "dns-server",
      "default-router",
      "ip helper-address",
  ...
  {
    "id": "Q1078",
    "question": "Which 802.11 management frame type is sent when a client roams between access points on the same\nSSID?",
    "options": [
  ...
  {
    "id": "Q1080",
    "question": "Refer to the exhibit. All switches are configured with the default STP priorities. During the STP\nelections, which switch becomes the root bridge if all interfaces are in the same VLAN?",
    "options": [
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "0d:E0:43:96:02:30",
          "attachTo": "dc1",
          "position": "below"
        },
        {
          "text": "0d:0E:18:1B:05:97",
          "attachTo": "dc2",
          "position": "below"
        },
        {
          "text": "0d:0E:18:2A:3C:9D",
          "attachTo": "dc3",
          "position": "below"
        },
        {
          "text": "0d:E0:19:A1:B3:19",
          "attachTo": "dc4",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q1111",
    "question": "Refer to the exhibit. SW2 is replaced because of a hardware failure. A network engineer starts to\nconfigure SW2 by copying the fa0/1 interface configuration from SW1. Which command must be\nconfigured on the fa0/1 interface of SW2 to enable PC1 to connect to PC2?",
    "options": [
      "switchport mode trunk",
      "switchport trunk native vlan 10",
      "switchport mode access",
  ...
  },
  {
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "Bridge Priority 57344, mac-address 0b:bb:e0:96:a3:86",
          "attachTo": "sw3",
          "position": "below"
        },
        {
          "text": "Bridge Priority 57344, mac-address 00:b6:c5:17:8e:89",
          "attachTo": "sw2",
          "position": "below"
        },
        {
          "text": "Bridge Priority 28672, mac-address 0c:d4:e9:1d:3c:24",
          "attachTo": "sw1",
          "position": "below"
        },
        {
          "text": "Bridge Priority 28672, mac-address 0b:09:23:33:b8:91",
          "attachTo": "sw4",
          "position": "below"
        }
      ]
  ...
  },
  {
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "Bridge Priority 32768, mac-address 0f:d7:9e:13:ab:82",
          "attachTo": "sw1",
          "position": "below"
        },
        {
          "text": "Bridge Priority 40960, mac-address 05:d8:33:09:8f:89",
          "attachTo": "sw2",
          "position": "below"
        },
        {
          "text": "Bridge Priority 32768, mac-address 01:1c:6c:66:b7:70",
          "attachTo": "sw3",
          "position": "below"
        },
        {
          "text": "Bridge Priority 40960, mac-address 04:44:97:51:63:17",
          "attachTo": "sw4",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q1133",
    "question": "Refer to the exhibit. An engineer is configuring a new router on the network and applied this\nconfiguration. Which additional configuration allows the PC to obtain its IP address from a DHCP\nserver?",
    "options": [
  ...
  {
    "id": "Q1140",
    "question": "Which IPsec encryption mode is appropriate when the destination of a packet differs from the security\ntermination point?",
    "options": [
      "transport",
      "main",
      "aggressive",
  ...
  {
    "id": "Q1141",
    "question": "A network administrator is evaluating network security in the aftermath of an attempted ARP spoofing\nattack. If Port-channel1 is the uplink interface of the access-layer switch toward the distribution-layer\nswitch, which two configurations must the administrator configure on the access-layer switch to\nprovide adequate protection? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q1149",
    "question": "Refer to the exhibit. The engineer configured the VLANs on the new AccSw2 switch. A router-on-a-\nstick is connected to both switches. How must the ports be configured on AccSw2 to establish full\nconnectivity between the two switches and for Server1?",
    "options": [
  ...
  {
    "id": "Q1151",
    "question": "Refer to the exhibit. Which address will the client contact to renew their IP address when the current\nlease expires?",
    "options": [
      "192.168.25.103",
      "192.168.25.1",
      "192.168.25.100",
      "192.168.25.254 Refer to the exhibit. Which switch becomes the root bridge?",
  ...
  {
    "id": "Q1158",
    "question": "When more than one AP-Manager interface is provisioned on a wireless LAN controller, how is the\nrequest handled by the AP?",
    "options": [
  ...
  {
    "id": "Q1162",
    "question": "Which SNMP message type is reliable and precedes an acknowledgment response from the SNMP\nmanager?",
    "options": [
      "Get",
      "Inform",
      "Traps",
  ...
  },
  {
    ...
    "options": [
      ...
      "is used when the network has multiple endpoint listeners",
      "reduces network complexity",
      "alleviates the shortage of IPv4 addresses Which interface condition is occurring in this output?",
      "collisions",
      "bad NIC",
      "duplex mismatch",
      "broadcast storm"
  ...
  {
    "id": "Q1174",
    "question": "Refer to the exhibit. A packet sourced from 172.16.32.254 is destined for 172.16.32.8. What is the\nsubnet mask of the preferred destination route?",
    "options": [
      "255.255.224.0",
      "255.255.255.0",
      "255.255.255.192",
  ...
  {
    "id": "Q1176",
    "question": "Refer to the exhibit. The IPv6 address for the LAN segment on router R1 must be configured using the\nEUI-64 format. When configured which Ipv6 address Is produced by the router?",
    "options": [
    ...
    "exhibit": {
      ...
      "links": [
        ...
        },
        {
          "from": "r1",
          "to": "sw1",
          "labelFrom": "E0/1 13-19-be-67-00-01"
        },
        {
          "from": "r2",
          "to": "sw2",
          "labelFrom": "E0/1 13-19-bf-69-00-01"
        },
        {
          "from": "sw1",
          "to": "eu1"
      ...
      "labels": [
        {
          "text": "2001:db8:1006:1968::/64",
          "attachTo": "sw1",
          "position": "below"
        },
        {
          "text": "2001:db8:1006:1969::/64",
          "attachTo": "sw2",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q1177",
    "question": "Refer to the exhibit. Users at a branch office are experiencing application performance issues, poor\nVoIP audio quality, and slow downloads. What is the cause of the issues?",
    "options": [
      "QoS queuing",
  ...
  {
    "id": "Q1179",
    "question": "An engineer needs to configure an access point to forward all client traffic through a wireless\ncontroller. Which mode must be enabled to accomplish this task?",
    "options": [
      "local",
      "monitor",
      "autonomous",
  ...
  {
    "id": "Q1180",
    "question": "An Ethernet frame arrived at switch interface G0/1, but the destination MAC address is missing from\nthe MAC address table. How does the switch process the frame?",
    "options": [
  ...
  {
    "id": "Q1181",
    "question": "In which circumstance would a network architect decide to implement a global unicast subnet instead\nof a unique local unicast subnet?",
    "options": [
  ...
  {
    "id": "Q1194",
    "question": "A network architect is deciding whether to implement Cisco autonomous access points or lightweight\naccess points. Which fact about firmware updates must the architect consider?",
    "options": [
  ...
  {
    "id": "Q1198",
    "question": "Refer to the exhibit. Router R1 receives static routing updates from routers A, B, C, and D. The\nnetwork engineer wants R1 to advertise static routes in OSPF area 1. Which summary address must be\nadvertised in OSPF?",
    "options": [
      "10.1.41.0/25",
      "10.1.40.0/24",
      "10.1.40.0/25",
      ...
      "links": [
        {
          "from": "a",
          "to": "r1",
          "labelFrom": "10.1.40.0/25"
        },
        {
          "from": "b",
          "to": "r1",
          "labelFrom": "10.1.40.128/29"
        },
        {
          "from": "c",
          "to": "r1",
          "labelFrom": "10.1.40.176/28"
        },
        {
          "from": "d",
          "to": "r1",
          "labelFrom": "10.1.41.224/29"
        },
        {
          "from": "r1",
          "to": "isp"
  ...
  {
    "id": "Q1200",
    "question": "Which type of IPv4 address must be assigned to a server to protect it from external access and allow\nonly internal users access while restricting internet access?",
    "options": [
      "private",
      "public",
      "global unicast",
  ...
  {
    "id": "Q1202",
    "question": "Refer to the exhibit. A network engineer is configuring a WLAN to connect with the 172.16.10.0/24\nnetwork on VLAN 20. The engineer wants to limit the number of devices that connect to the WLAN on\nthe USERWL SSID to 125. Which configuration must the engineer perform on the WLC?",
    "options": [
    ...
    "exhibit": {
      ...
      "devices": [
        {
          "id": "ap",
          "type": "switch",
          "label": "AP (SSID USERWL, 172.16.10.0/24)",
          "x": 200,
          "y": 150
        },
        {
      ...
      "links": [
        ...
        },
        {
          "from": "cloud",
          "to": "wlc",
          "labelTo": "Vlan 20 172.16.10.0/24"
        }
      ]
    },
    "blueprint_section": "2.9",
  ...
  {
    "id": "Q1203",
    "question": "Refer to the exhibit. An LACP EtherChannel between two directly connected switches is in the\nconfiguration process. Which command must be configured on switch SW2s Gi0/1-2 interfaces to\nestablish the channel to SW1?",
    "options": [
      "channel-group 1 mode on",
  ...
  {
    "id": "Q1204",
    "question": "Refer to the exhibit. An administrator must connect SW_1 and the printer to the network. SW_2\nrequires DTP to be used for the connection to SW_1. The printer is configured as an access port with\nVLAN 5. Which set of commands completes the connectivity?",
    "options": [
  ...
  {
    "id": "Q1207",
    "question": "What is the temporary state that switch ports always enter immediately after the boot process when\nRapid PVST+ is used?",
    "options": [
      "forwarding",
      "listening",
      "learning",
  ...
  {
    "id": "Q1209",
    "question": "Refer to the exhibit. A packet sourced from 10.10.10.1 is destined for 172.16.3.254. What is the subnet\nmask of the destination route?",
    "options": [
      "0.0.0.0",
      "255.255.254.0",
      "255.255.255.0",
  ...
  {
    "id": "Q1210",
    "question": "Refer to the exhibit. IPv6 must be implemented on R1 to the ISP. The uplink between R1 and the ISP\nmust be configured with a manual assignment, and the LAN interface must be self-provisioned. Both\nconnections must use the applicable IPv6 networks. Which two configurations must be applied to R1?\n(Choose two.)",
    "options": [
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "IPv6 WAN 2001:db8:0F1B:FCCB:ACCE:FCED:ACBD:FA0:/127",
          "attachTo": "isp",
          "position": "below"
        },
        {
          "text": "IPv6 LAN 2001:db8:0000:AFFF:0000:0000:0000:0000:/64",
          "attachTo": "r1",
          "position": "below"
        }
      ]
    ...
    "exhibit": [
      {
        ...
        "devices": [
          {
            "id": "dns",
            "type": "pc",
            "label": "Domain Name Server 196.1.38.132",
            "x": 250,
            "y": 60
          },
          {
        ...
        "links": [
          ...
          },
          {
            "from": "ra",
            "to": "isp",
            "labelFrom": "S0/0/0 200.100.100.1/32"
          },
          {
            "from": "isp",
            "to": "rb"
          },
          {
            "from": "ra",
            "to": "hosta",
            "labelFrom": "G0/0/0 192.168.1.254/24"
          },
          {
            "from": "ra",
            "to": "hostb"
  ...
  {
    "id": "Q1214",
    "question": "Which AP mode is used for capturing wireless traffic and forwarding that traffic to a PC that is running\na packet analyzer?",
    "options": [
      "bridge",
      "monitor",
      "rouge detector",
    ...
    "exhibit": {
      ...
      "links": [
        ...
        },
        {
          "from": "r1",
          "to": "sw1",
          "labelFrom": "E0/1 12-d2-df-cc-00-01"
        },
        {
          "from": "r2",
          "to": "sw2",
          "labelFrom": "E0/1 12-d8-ba-c2-00-01"
        },
        {
          "from": "sw1",
          "to": "dns1"
      ...
      "labels": [
        {
          "text": "DMZ 2001:db8:db95:1008::/64",
          "attachTo": "sw1",
          "position": "below"
        },
        {
          "text": "2001:db8:d955:1008::/64",
          "attachTo": "sw2",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q1220",
    "question": "Which port type does a lightweight AP use to connect to the wired network when configured in\nFlexConnect mode with local switching and VLAN tagging?",
    "options": [
      "trunk",
      "LAG",
      "EtherChannel",
  ...
  {
    "id": "Q1221",
    "question": "Refer to the exhibit. PC A is communicating with another device at IP address 10.227.151.255.\nThrough which router does router Y route the traffic?",
    "options": [
      "router A",
      "router B",
      "router C",
        ...
        "links": [
          {
            "from": "pca",
            "to": "ry",
            "labelTo": "G0/1 10.223.4.1"
          },
          {
            "from": "ry",
            "to": "ra",
            "labelFrom": "G0/0 10.224.4.1"
          },
          {
            "from": "ry",
            "to": "rb"
  ...
  {
    "id": "Q1222",
    "question": "Refer to the exhibit. VoIP is being implemented in the network using VLAN ID 73 and named \"VoIP\".\nEach user needs a Cisco IP phone at their desk. Switchport e0/0 has been configured as an access port\nin the data VLAN. Cisco Discovery Protocol is enabled globally. Which command sequence completed\nthe configuration?",
    "options": [
  ...
  {
    "id": "Q1223",
    "question": "Refer to the exhibit. Which IP route command created the best path for a packet destined for\n10.10.10.3?\nQ1224 Nachfragen",
    "options": [
  ...
  {
    "id": "Q1229",
    "question": "In what way does a network supervisor reduce maintenance costs while maintaining network integrity\non a traditionally managed network?",
    "options": [
  ...
  {
    "id": "Q1230",
    "question": "Which type of wired port is required when an AP offers one unique SSID, passes client data and\nmanagement traffic, and is in autonomous mode?",
    "options": [
      "trunk",
      "default",
      "access",
  ...
  {
    "id": "Q1231",
    "question": "Refer to the exhibit. A network engineer must configure the WLC to allow only DHCP and DNS\npackets for User1 and User2. Which configuration must be used?",
    "options": [
  ...
  {
    "id": "Q1232",
    "question": "Which connection type is used when an engineer connects to an AP without a configured IP address or\ndial-up number to manage the device?",
    "options": [
      "AUX",
      "Ethernet",
      "VIY",
  ...
  {
    "id": "Q1238",
    "question": "Which encryption mode is used when a packet is sent from a site-to-site VPN connection where the\nsource and destination IP address portion of a packet is unencrypted?",
    "options": [
      "PPTP",
      "Secure Shell",
      "Transport",
  ...
  {
    "id": "Q1239",
    "question": "What is a reason why an administrator would choose to implement an automated network management\napproach?",
    "options": [
  ...
  {
    "id": "Q1241",
    "question": "Refer to the exhibit. A packet sourced from 172.18.33.2 is destined for 172.18.32.38. Where does the\nrouter forward the packet?",
    "options": [
      "10.1.1.1",
      "10.1.1.3",
      "Loopback0",
  ...
  {
    "id": "Q1242",
    "question": "Refer to the exhibit. An administrator is configuring a new WLAN for a wireless network that has these\nrequirements:\n• Dual-band clients that connect to the WLAN must be directed to the 5-GHz spectrum.\n• Wireless clients on this WLAN must be able to apply VLAN settings on the returned RADIUS\nattributes.\nWhich two actions meet these requirements? (Choose two.)",
    "options": [
  ...
  {
    "id": "Q1245",
    "question": "Refer to the exhibit. The switch cat9k-acc-1 connects users to the campus LAN. Printing services are\ninaccessible through the network. Which interface issue is causing the connectivity problems?",
    "options": [
  ...
  {
    "id": "Q1246",
    "question": "Which standard is required when more than one distribution system port and only one IP address are\nconfigured for a Cisco WLC?",
    "options": [
      "802.3ad",
      "802.1q",
      "802.1d",
  ...
  {
    "id": "Q1250",
    "question": "Company has decided to require multifactor authentication for all systems. Which set of parameters\nmeets the requirement?",
    "options": [
    ...
    "exhibit": {
      ...
      "links": [
        ...
        },
        {
          "from": "r1",
          "to": "sw1",
          "labelFrom": "E0/1 13-ba-be-e7-00-01"
        },
        {
          "from": "r2",
          "to": "sw2",
          "labelFrom": "E0/1 13-be-bf-b9-00-01"
        },
        {
          "from": "sw1",
          "to": "eu1"
      ...
      "labels": [
        {
          "text": "2001:db8:db69:1469::/64",
          "attachTo": "sw1",
          "position": "below"
        },
        {
          "text": "2001:db8:bd69:1469::/64",
          "attachTo": "sw2",
          "position": "below"
        }
      ]
  ...
  },
  {
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "Bridge Priority 61440, mac-address 00:10:a1:69:c9:28",
          "attachTo": "sw1",
          "position": "below"
        },
        {
          "text": "Bridge Priority 61440, mac-address 00:10:a1:27:81:6c",
          "attachTo": "sw2",
          "position": "below"
        },
        {
          "text": "Bridge Priority 53248, mac-address 00:10:a1:35:d9:86",
          "attachTo": "sw3",
          "position": "below"
        },
        {
          "text": "Bridge Priority 53248, mac-address 00:10:a1:22:11:63",
          "attachTo": "sw4",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q1274",
    "question": "Refer to the exhibit. PC A is communicating with another device at IP address 10.225.34.225. Through\nwhich router does router Y route the traffic?",
    "options": [
      "router A",
      "router B",
      "router C",
    ...
    "exhibit": {
      ...
      "links": [
        ...
        },
        {
          "from": "r2",
          "to": "sw1",
          "labelFrom": "E0/1 ca-01-3b-8b-00-01"
        },
        {
          "from": "r1",
          "to": "sw2",
          "labelFrom": "E0/1 ca-01-b3-b8-00-01"
        },
        {
          "from": "sw1",
          "to": "fs1"
      ...
      "labels": [
        {
          "text": "2001:db8:3bb8:3181::/64",
          "attachTo": "sw1",
          "position": "below"
        },
        {
          "text": "2001:db8:3bb8:3bb1::/64",
          "attachTo": "sw2",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q1287",
    "question": "Which cable type must be used when connecting two like devices together using these criteria?\n• Pins 1 to 3 and 2 to 6 are required.\n• Auto detection MDI-X is unavailable.",
    "options": [
      "straight-through",
      "console",
      "crossover",
  ...
  {
    "id": "Q1288",
    "question": "Which selections must be used on the WLC when implementing a RADIUS server for wireless\nauthentication?",
    "options": [
  ...
  {
    "id": "Q1290",
    "question": "Which port-security violation mode drops traffic from unknown MAC addresses and forwards an\nSNMP trap?",
    "options": [
      "shutdown VLAN",
      "protect",
      "restrict",
  ...
  },
  {
    ...
    "exhibit": {
      ...
      "labels": [
        {
          "text": "Bridge Priority 20480, mac-address 00:10:a1:71:e3:35",
          "attachTo": "sw1",
          "position": "below"
        },
        {
          "text": "Bridge Priority 20480, mac-address 00:10:a1:54:4e:50",
          "attachTo": "sw2",
          "position": "below"
        },
        {
          "text": "Bridge Priority 57344, mac-address 00:10:a1:93:09:2d",
          "attachTo": "sw3",
          "position": "below"
        },
        {
          "text": "Bridge Priority 57344, mac-address 00:10:a1:57:61:80",
          "attachTo": "sw4",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q1315",
    "question": "A DHCP pool has been created with the name NOCC. The pool is using 192.168.20.0/24 and must use\nthe next to last usable IP address as the default gateway for the DHCP clients. What is the next step in\nthe process?",
    "options": [
    ...
    "exhibit": {
      ...
      "links": [
        ...
        },
        {
          "from": "r1",
          "to": "sw1",
          "labelFrom": "E0/1 ca-01-be-4a-00-01"
        },
        {
          "from": "r2",
          "to": "sw2",
          "labelFrom": "E0/1 ca-01-bf-a4-00-01"
        },
        {
          "from": "sw1",
          "to": "eu1"
      ...
      "labels": [
        {
          "text": "2001:db8:1a44:41a4::/64",
          "attachTo": "sw1",
          "position": "below"
        },
        {
          "text": "2001:db8:1aa4:41a4::/64",
          "attachTo": "sw2",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q1321",
    "question": "What does a router do when it is configured with the default DNS lookup settings, and a URL is\nentered on the CLI?",
    "options": [
    ...
    "exhibit": {
      ...
      "links": [
        ...
        },
        {
          "from": "r1",
          "to": "sw1",
          "labelFrom": "E0/1 ca-01-6b-4b-00-01"
        },
        {
          "from": "r2",
          "to": "sw2",
          "labelFrom": "E0/1 ca-01-b6-b4-00-01"
        },
        {
          "from": "sw1",
          "to": "dns1"
      ...
      "labels": [
        {
          "text": "2001:db8:9bb6:916b::/64",
          "attachTo": "sw1",
          "position": "below"
        },
        {
          "text": "2001:db8:9bb6:6bb9::/64",
          "attachTo": "sw2",
          "position": "below"
        }
      ]
  ...
  {
    "id": "Q1339",
    "question": "Refer to the exhibit. PC1 regularly sends 1800 Mbps of traffic to the server. A network engineer needs\nto configure the EtherChannel to disable Port Channel 1 between SW1 and SW2 when the Ge0/0 and\nGe0/1 ports on SW2 go down. Which configuration must the engineer apply to the switch?",
    "options": [
    ...
    "exhibit": {
      ...
      "links": [
        ...
        },
        {
          "from": "sw1",
          "to": "sw2",
          "labelFrom": "Ge0/0 Ge0/1 Ge0/2",
          "labelTo": "Ge0/0 Ge0/1 Ge0/2"
        },
        {
          "from": "sw1",
          "to": "sw3"
  ...
  {
    "id": "Q1340",
    "question": "An administrator is configuring a Cisco Catalyst switch so that it will accept management connections\nonly from hosts in the 203.0.113.0/24 network. Other traffic passing through the switch must transit\nwithout interruption. Which two configurations must the engineer apply to the router? (Choose two.)",
    "options": [
