...
export const QUIZ_DHCP: Quiz = {
  ...
  questions: [
    ...
    {
      id: uid(), type: "single-choice", points: 10,
      text: "Auf welchem Interface eines Routers wird 'ip helper-address' konfiguriert, wenn der DHCP-Server in einem anderen Subnetz steht?",
      explanation: "Der Befehl gehört auf das CLIENT-seitige Interface (das SVI/Subinterface des Client-VLANs). Nur dort fängt der Router den Client-Broadcast ab und trägt seine Interface-IP ins giaddr-Feld ein.",
      answers: [
        { id: "a", text: "Auf dem Interface Richtung DHCP-Server", isCorrect: false },
        { id: "b", text: "Auf dem Interface/SVI, das den Clients zugewandt ist", isCorrect: true },
        { id: "c", text: "Auf dem WAN-Interface (Default Route)", isCorrect: false },
        { id: "d", text: "Auf der Loopback-Schnittstelle", isCorrect: false },
      ],
    },
    {
      id: uid(), type: "single-choice", points: 10,
      text: "Welche Information trägt der DHCP-Relay-Agent in das weitergeleitete Paket ein, damit der Server den richtigen Adresspool wählt?",
      explanation: "Der Relay-Agent setzt seine eigene (Client-seitige) Interface-IP in das giaddr-Feld. Der Server liest giaddr und vergibt eine Adresse aus dem passenden Subnetz-Pool.",
      answers: [
        { id: "a", text: "Die MAC-Adresse des Servers", isCorrect: false },
        { id: "b", text: "Die eigene Interface-IP im giaddr-Feld", isCorrect: true },
        { id: "c", text: "Die Broadcast-Adresse des Servers", isCorrect: false },
        { id: "d", text: "Den DNS-Namen des Clients", isCorrect: false },
      ],
    },
    {
      id: uid(), type: "single-choice", points: 10,
      text: "Ein PC zeigt nach dem Boot die Adresse 169.254.137.42. Was bedeutet das?",
      explanation: "169.254.0.0/16 ist der APIPA-/Link-Local-Bereich (RFC 3927). Windows vergibt sich diese Adresse selbst, wenn KEIN DHCP-Server antwortet — ein eindeutiges Signal für ein DHCP-Problem.",
      answers: [
        { id: "a", text: "Der PC hat erfolgreich eine IP per DHCP erhalten", isCorrect: false },
        { id: "b", text: "Der PC hat keine DHCP-Antwort erhalten (APIPA)", isCorrect: true },
        { id: "c", text: "Der PC ist mit dem Internet verbunden", isCorrect: false },
        { id: "d", text: "Der PC nutzt eine statische öffentliche IP", isCorrect: false },
      ],
    },
    {
      id: uid(), type: "true-false", points: 5,
      text: "Eine APIPA-Adresse (169.254.x.x) ist nicht routbar — ein Host damit erreicht kein Gateway und kein anderes Subnetz.",
      explanation: "Wahr. 169.254.0.0/16 ist link-local (RFC 3927). Zwei APIPA-Hosts im selben L2-Segment erreichen sich gegenseitig, aber es gibt kein Default-Gateway — also kein Inter-VLAN/Internet.",
      answers: [
        { id: "a", text: "Wahr", isCorrect: true },
        { id: "b", text: "Falsch", isCorrect: false },
      ],
    ...
    {
      id: uid(), type: "single-choice", points: 10,
      text: "Welcher Port sollte bei DHCP-Snooping als 'trusted' konfiguriert werden?",
      explanation: "Nur der Uplink/Port zum echten DHCP-Server (bzw. Relay/Trunk) wird 'trust'. Alle Access-Ports zu Endgeräten bleiben untrusted, damit dort kein Rogue-Server antworten kann.",
      answers: [
        { id: "a", text: "Alle Access-Ports zu den Endgeräten", isCorrect: false },
        { id: "b", text: "Der Uplink-Port zum echten DHCP-Server", isCorrect: true },
        { id: "c", text: "Kein Port — alle bleiben untrusted", isCorrect: false },
        { id: "d", text: "Nur Ports mit Voice-VLAN", isCorrect: false },
      ],
    },
    {
      id: uid(), type: "single-choice", points: 10,
      text: "Was verwirft ein DHCP-Snooping-Switch auf einem untrusted Port?",
      explanation: "Auf untrusted Ports lässt der Switch nur Client-Nachrichten (DISCOVER/REQUEST) durch und verwirft Server-Nachrichten (OFFER/ACK/NAK) — so kann ein Rogue-Server dort nicht antworten.",
      answers: [
        { id: "a", text: "Client-Nachrichten wie DISCOVER", isCorrect: false },
        { id: "b", text: "Server-Nachrichten wie OFFER und ACK", isCorrect: true },
        { id: "c", text: "ARP-Anfragen", isCorrect: false },
        { id: "d", text: "Sämtlichen DHCP-Verkehr", isCorrect: false },
      ],
    },
    {
      id: uid(), type: "multiple-choice", points: 15,
      text: "Welche Sicherheitsfunktionen nutzen die DHCP-Snooping-Binding-Tabelle als Grundlage? (Mehrere Antworten)",
      explanation: "Die Binding-Tabelle (MAC↔IP↔VLAN↔Port) ist die Basis für Dynamic ARP Inspection (DAI) und IP Source Guard — beide prüfen Pakete gegen diese verlässlichen Bindings.",
      answers: [
        { id: "a", text: "Dynamic ARP Inspection (DAI)", isCorrect: true },
        { id: "b", text: "IP Source Guard", isCorrect: true },
        { id: "c", text: "Spanning Tree Protocol", isCorrect: false },
        { id: "d", text: "EtherChannel/LACP", isCorrect: false },
      ],
    },
    {
      id: uid(), type: "single-choice", points: 10,
      text: "Ein Router ist DHCP-Server für 192.168.1.0/24 mit der LAN-IP 192.168.1.1. Welcher Befehl verhindert, dass das Gateway als Client-Adresse vergeben wird?",
      explanation: "'ip dhcp excluded-address' nimmt Adressen aus dem Pool heraus. Fehlt der Befehl für 192.168.1.1, kann der Server die Gateway-IP an einen Client vergeben → Adresskonflikt.",
      answers: [
        { id: "a", text: "ip dhcp excluded-address 192.168.1.1", isCorrect: true },
        { id: "b", text: "ip dhcp reserved 192.168.1.1", isCorrect: false },
        { id: "c", text: "no ip dhcp 192.168.1.1", isCorrect: false },
        { id: "d", text: "ip dhcp deny 192.168.1.1", isCorrect: false },
      ],
    },
    {
      id: uid(), type: "single-choice", points: 10,
      text: "Welche DHCP-Nachricht sendet der Client als Broadcast, OBWOHL er den Server bereits kennt?",
      explanation: "Der REQUEST ist ein Broadcast, damit alle DHCP-Server ihn hören — die nicht gewählten Server geben dadurch ihr Angebot wieder frei.",
      answers: [
        { id: "a", text: "DISCOVER", isCorrect: false },
        { id: "b", text: "REQUEST", isCorrect: true },
        { id: "c", text: "ACK", isCorrect: false },
        { id: "d", text: "RELEASE", isCorrect: false },
      ],
    },
    {
      id: uid(), type: "single-choice", points: 10,
      text: "Mit welcher DHCP-Nachricht beginnt die Lease-Zeit zu laufen?",
      explanation: "Erst mit dem ACK des Servers ist die Vergabe bestätigt und die Lease-Uhr startet. DISCOVER/OFFER/REQUEST sind die vorangehenden Schritte.",
      answers: [
        { id: "a", text: "DISCOVER", isCorrect: false },
        { id: "b", text: "OFFER", isCorrect: false },
        { id: "c", text: "REQUEST", isCorrect: false },
        { id: "d", text: "ACK", isCorrect: true },
      ],
    },
    {
      id: uid(), type: "single-choice", points: 10,
      text: "Bei welchem Anteil der Lease-Dauer versucht der Client ein Renewal per Unicast an den ursprünglichen Server (T1)?",
      explanation: "T1 = 50 % der Lease. Der Client schickt einen Unicast-REQUEST direkt an den Server, der ihm die Adresse vergeben hat.",
      answers: [
        { id: "a", text: "25 %", isCorrect: false },
        { id: "b", text: "50 %", isCorrect: true },
        { id: "c", text: "87,5 %", isCorrect: false },
        { id: "d", text: "100 %", isCorrect: false },
      ],
    },
    {
      id: uid(), type: "single-choice", points: 10,
      text: "Was passiert bei T2 (87,5 % der Lease), wenn das Renewal bis dahin gescheitert ist?",
      explanation: "Bei T2 geht der Client ins Rebinding: ein Broadcast-REQUEST an JEDEN erreichbaren DHCP-Server, weil der ursprüngliche Server offenbar nicht erreichbar ist.",
      answers: [
        { id: "a", text: "Der Client gibt die IP sofort auf", isCorrect: false },
        { id: "b", text: "Rebinding: Broadcast-REQUEST an jeden Server", isCorrect: true },
        { id: "c", text: "Der Client wechselt zu APIPA", isCorrect: false },
        { id: "d", text: "Nichts — die Lease läuft einfach weiter", isCorrect: false },
      ],
    },
    {
      id: uid(), type: "single-choice", points: 10,
      text: "Welche DHCP-Optionen liefern Default-Gateway (Router) bzw. DNS-Server?",
      explanation: "Option 3 = Router/Default-Gateway, Option 6 = DNS-Server. Beide werden gern verwechselt.",
      answers: [
        { id: "a", text: "Option 3 = Gateway, Option 6 = DNS", isCorrect: true },
        { id: "b", text: "Option 6 = Gateway, Option 3 = DNS", isCorrect: false },
        { id: "c", text: "Option 1 = Gateway, Option 51 = DNS", isCorrect: false },
        { id: "d", text: "Option 53 = Gateway, Option 50 = DNS", isCorrect: false },
      ],
    },
    {
      id: uid(), type: "single-choice", points: 10,
      text: "Welche DHCP-Option überträgt die Lease-Dauer?",
      explanation: "Option 51 (IP Address Lease Time) enthält die Lease-Dauer in Sekunden.",
      answers: [
        { id: "a", text: "Option 3", isCorrect: false },
        { id: "b", text: "Option 6", isCorrect: false },
        { id: "c", text: "Option 51", isCorrect: true },
        { id: "d", text: "Option 82", isCorrect: false },
      ],
    },
    {
      id: uid(), type: "single-choice", points: 10,
      text: "Welche Funktion hat DHCP Option 82 (Relay Agent Information)?",
      explanation: "Option 82 wird vom Relay/Snooping-Switch eingefügt und enthält Circuit-ID (Port/VLAN) und Remote-ID (Switch). So weiß der Server, von welchem physischen Port die Anfrage stammt.",
      answers: [
        { id: "a", text: "Sie überträgt die Subnetzmaske", isCorrect: false },
        { id: "b", text: "Sie kennzeichnet Port/Switch-Herkunft der Anfrage", isCorrect: true },
        { id: "c", text: "Sie verschlüsselt das DHCP-Paket", isCorrect: false },
        { id: "d", text: "Sie verlängert die Lease automatisch", isCorrect: false },
      ],
    },
    {
      id: uid(), type: "single-choice", points: 10,
      text: "Wie wirkt ein Rogue-DHCP-Server (DHCP-Spoofing) als Angriff?",
      explanation: "Der Rogue-Server weist Clients ein falsches Default-Gateway (seine eigene IP) zu — der Traffic läuft dann über den Angreifer (Man-in-the-Middle). DHCP-Snooping verhindert das.",
      answers: [
        { id: "a", text: "Er überlastet die CPU des Switches", isCorrect: false },
        { id: "b", text: "Er verteilt ein falsches Gateway → Man-in-the-Middle", isCorrect: true },
        { id: "c", text: "Er löscht die MAC-Adresstabelle", isCorrect: false },
        { id: "d", text: "Er deaktiviert Spanning Tree", isCorrect: false },
      ],
    },
    {
      id: uid(), type: "single-choice", points: 10,
      text: "Im Debug erscheint 'DHCPD: there is no address pool for 192.168.10.1'. Was ist die wahrscheinliche Ursache?",
      explanation: "Der Server hat keinen Pool für das per giaddr angefragte Subnetz (192.168.10.0/24). Typisch bei Relay-Setups: Pool fehlt oder das Client-Subnetz ist nicht konfiguriert.",
      answers: [
        { id: "a", text: "Der Client hat eine statische IP", isCorrect: false },
        { id: "b", text: "Kein passender Pool für das angefragte (giaddr-)Subnetz", isCorrect: true },
        { id: "c", text: "Das Kabel ist defekt", isCorrect: false },
        { id: "d", text: "Die Lease-Zeit ist abgelaufen", isCorrect: false },
      ],
    },
    {
      id: uid(), type: "single-choice", points: 10,
      text: "Mit welchem Befehl begrenzt man auf einem Access-Port die DHCP-Pakete pro Sekunde, um DHCP-Starvation abzubremsen?",
      explanation: "'ip dhcp snooping limit rate <n>' begrenzt die DHCP-Pakete/s am Port. Bei DHCP-Starvation flutet ein Angreifer den Server mit DISCOVER-Paketen, um den Pool zu erschöpfen — das Rate-Limit bremst das aus.",
      answers: [
        { id: "a", text: "ip dhcp snooping limit rate 10", isCorrect: true },
        { id: "b", text: "switchport port-security maximum 10", isCorrect: false },
        { id: "c", text: "ip dhcp limit 10", isCorrect: false },
        { id: "d", text: "storm-control dhcp level 10", isCorrect: false },
      ],
    },
  ],
};
